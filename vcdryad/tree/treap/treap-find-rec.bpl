...
procedure treap_find_rec(P#x: $ptr, P#k: int) returns ($result: int);
  ...
  ensures F#treap_reach($s, $phys_ptr_cast(P#x, ^b_node)) == F#treap_reach(old($s), $phys_ptr_cast(P#x, ^b_node));
  ensures F#treap_keys($s, $phys_ptr_cast(P#x, ^b_node)) == F#treap_keys(old($s), $phys_ptr_cast(P#x, ^b_node));
  ensures F#treap_prios($s, $phys_ptr_cast(P#x, ^b_node)) == F#treap_prios(old($s), $phys_ptr_cast(P#x, ^b_node));
  ensures F#treap_min_key($s, $phys_ptr_cast(P#x, ^b_node)) == F#treap_min_key(old($s), $phys_ptr_cast(P#x, ^b_node));
  ensures F#treap_max_key($s, $phys_ptr_cast(P#x, ^b_node)) == F#treap_max_key(old($s), $phys_ptr_cast(P#x, ^b_node));
  ensures F#treap_max_prio($s, $phys_ptr_cast(P#x, ^b_node)) == F#treap_max_prio(old($s), $phys_ptr_cast(P#x, ^b_node));
          ...
          anon5:
            ...
            if (P#k < $rd_inv($s, b_node.key, $phys_ptr_cast(P#x, ^b_node)))
            {
              anon3:
                ...
                assume $full_stop_ext(#tok$2^30.17, $s);
            ...
            else
            {
              anon4:
                ...
                assume $full_stop_ext(#tok$2^33.17, $s);
...
axiom (forall Q#__vcc_state$1^230.9#tc3#1355: $state, Q#x$1^230.9#dt1#1325: $ptr, Q#i$1^230.9#tc1#1326: int :: {:weight 10} { $intset_in(Q#i$1^230.9#tc1#1326, F#treap_keys(Q#__vcc_state$1^230.9#tc3#1355, $phys_ptr_cast(Q#x$1^230.9#dt1#1325, ^b_node))) } $good_state(Q#__vcc_state$1^230.9#tc3#1355) && $in_range_i4(Q#i$1^230.9#tc1#1326) ==> Q#i$1^230.9#tc1#1326 < F#treap_min_key(Q#__vcc_state$1^230.9#tc3#1355, $phys_ptr_cast(Q#x$1^230.9#dt1#1325, ^b_node)) ==> !$intset_in(Q#i$1^230.9#tc1#1326, F#treap_keys(Q#__vcc_state$1^230.9#tc3#1355, $phys_ptr_cast(Q#x$1^230.9#dt1#1325, ^b_node))));

axiom (forall Q#__vcc_state$1^231.9#tc3#1356: $state, Q#x$1^231.9#dt1#1327: $ptr, Q#i$1^231.9#tc1#1328: int :: {:weight 10} { $intset_in(Q#i$1^231.9#tc1#1328, F#treap_keys(Q#__vcc_state$1^231.9#tc3#1356, $phys_ptr_cast(Q#x$1^231.9#dt1#1327, ^b_node))) } $good_state(Q#__vcc_state$1^231.9#tc3#1356) && $in_range_i4(Q#i$1^231.9#tc1#1328) ==> Q#i$1^231.9#tc1#1328 > F#treap_max_key(Q#__vcc_state$1^231.9#tc3#1356, $phys_ptr_cast(Q#x$1^231.9#dt1#1327, ^b_node)) ==> !$intset_in(Q#i$1^231.9#tc1#1328, F#treap_keys(Q#__vcc_state$1^231.9#tc3#1356, $phys_ptr_cast(Q#x$1^231.9#dt1#1327, ^b_node))));

axiom (forall Q#__vcc_state$1^232.9#tc3#1357: $state, Q#x$1^232.9#dt1#1329: $ptr, Q#i$1^232.9#tc1#1330: int :: {:weight 10} { $intset_in(Q#i$1^232.9#tc1#1330, F#treap_prios(Q#__vcc_state$1^232.9#tc3#1357, $phys_ptr_cast(Q#x$1^232.9#dt1#1329, ^b_node))) } $good_state(Q#__vcc_state$1^232.9#tc3#1357) && $in_range_i4(Q#i$1^232.9#tc1#1330) ==> Q#i$1^232.9#tc1#1330 > F#treap_max_prio(Q#__vcc_state$1^232.9#tc3#1357, $phys_ptr_cast(Q#x$1^232.9#dt1#1329, ^b_node)) ==> !$intset_in(Q#i$1^232.9#tc1#1330, F#treap_prios(Q#__vcc_state$1^232.9#tc3#1357, $phys_ptr_cast(Q#x$1^232.9#dt1#1329, ^b_node))));

axiom (forall Q#__vcc_state$1^233.9#tc3#1358: $state, Q#x$1^233.9#dt1#1331: $ptr :: {:weight 10} { F#treap(Q#__vcc_state$1^233.9#tc3#1358, $phys_ptr_cast(Q#x$1^233.9#dt1#1331, ^b_node)) } { F#treap_max_prio(Q#__vcc_state$1^233.9#tc3#1358, $phys_ptr_cast(Q#x$1^233.9#dt1#1331, ^b_node)) } { $rd_inv(Q#__vcc_state$1^233.9#tc3#1358, b_node.prio, $phys_ptr_cast(Q#x$1^233.9#dt1#1331, ^b_node)) } $good_state(Q#__vcc_state$1^233.9#tc3#1358) && true ==> F#treap(Q#__vcc_state$1^233.9#tc3#1358, $phys_ptr_cast(Q#x$1^233.9#dt1#1331, ^b_node)) ==> F#treap_max_prio(Q#__vcc_state$1^233.9#tc3#1358, $phys_ptr_cast(Q#x$1^233.9#dt1#1331, ^b_node)) == $rd_inv(Q#__vcc_state$1^233.9#tc3#1358, b_node.prio, $phys_ptr_cast(Q#x$1^233.9#dt1#1331, ^b_node)));
...
const unique #tok$2^33.17: $token;

const unique #tok$2^30.17: $token;
...
const unique #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Ctree?5Ctreap?5Ctreap?2Dfind?2Drec.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Ctree?5Ctreap?5Ctreap?2Dfind?2Drec.c);

const unique #file^z?3A?5Cinvariantsynthesis?5Csubmit?5Ctree?5Ctreap?5Cdryad_treap.h: $token;

axiom $file_name_is(1, #file^z?3A?5Cinvariantsynthesis?5Csubmit?5Ctree?5Ctreap?5Cdryad_treap.h);
