  ...
  anon3:
    ...
    else
    {
      anon2:
        ...
        assume $full_stop_ext(#tok$2^28.12, $s);
        ...
        assume $full_stop_ext(#tok$2^36.12, $s);
...
const unique #tok$2^36.12: $token;

const unique #tok$2^31.3: $token;

const unique #tok$2^28.12: $token;
...
const unique #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Ctree?5Ctraverse?5Ctraverse?2Dinorder.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Ctree?5Ctraverse?5Ctraverse?2Dinorder.c);

const unique #file^z?3A?5Cinvariantsynthesis?5Csubmit?5Ctree?5Ctraverse?5Cdryad_intree.h: $token;

axiom $file_name_is(1, #file^z?3A?5Cinvariantsynthesis?5Csubmit?5Ctree?5Ctraverse?5Cdryad_intree.h);
