...
ensures b0000 ==> (F#tree($s,$phys_ptr_cast(P#x,^t_node)));
ensures b0001 ==> ((F#tree_reach($s,$phys_ptr_cast(P#x,^t_node)) == F#tree_reach(old($s),$phys_ptr_cast(P#x,^t_node))));
ensures b0002 ==> ($non_null($phys_ptr_cast(P#x,^t_node)));
ensures b0003 ==> ($is_null($phys_ptr_cast(P#x,^t_node)));
ensures b0004 ==> (($non_null($phys_ptr_cast(P#x,^t_node)) ==> $non_null($rd_phys_ptr($s,t_node.left,$phys_ptr_cast(P#x,^t_node),^t_node))));
ensures b0005 ==> (($non_null($phys_ptr_cast(P#x,^t_node)) ==> $is_null($rd_phys_ptr($s,t_node.left,$phys_ptr_cast(P#x,^t_node),^t_node))));
ensures b0006 ==> (($non_null($phys_ptr_cast(P#x,^t_node)) ==> $non_null($rd_phys_ptr($s,t_node.right,$phys_ptr_cast(P#x,^t_node),^t_node))));
ensures b0007 ==> (($non_null($phys_ptr_cast(P#x,^t_node)) ==> $is_null($rd_phys_ptr($s,t_node.right,$phys_ptr_cast(P#x,^t_node),^t_node))));
ensures b0008 ==> ((F#tree_size($s,$phys_ptr_cast(P#x,^t_node)) == F#tree_size(old($s),$phys_ptr_cast(P#x,^t_node))));
  ...
  anon3:
    ...
    else
    {
      anon2:
        ...
        assume $full_stop_ext(#tok$2^22.12, $s);
        ...
        assume $full_stop_ext(#tok$2^25.12, $s);
        ...
        assume $full_stop_ext(#tok$2^28.3, $s);
...
const unique #tok$2^28.3: $token;

const unique #tok$2^25.12: $token;

const unique #tok$2^22.12: $token;
...
const unique #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Ctraverse?2Dtree?5Ctraverse?2Dposttorder.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Ctraverse?2Dtree?5Ctraverse?2Dposttorder.c);

const unique #file^z?3A?5Cinvariantsynthesis?5Cvcdryad?5Cvcc?5Chost?5Cbin?5Ctests?5Ctraverse?2Dtree?5Cdryad_posttree.h: $token;

axiom $file_name_is(1, #file^z?3A?5Cinvariantsynthesis?5Cvcdryad?5Cvcc?5Chost?5Cbin?5Ctests?5Ctraverse?2Dtree?5Cdryad_posttree.h);
