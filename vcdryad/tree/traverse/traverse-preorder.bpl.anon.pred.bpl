  ...
  anon3:
    ...
    else
    {
      anon2:
        ...
        assume $full_stop_ext(#tok$2^26.12, $s);
        ...
        assume $full_stop_ext(#tok$2^29.12, $s);
...
const unique #tok$2^29.12: $token;

const unique #tok$2^26.12: $token;
...
const unique #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Ctraverse?2Dtree?5Ctraverse?2Dpreorder.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Ctraverse?2Dtree?5Ctraverse?2Dpreorder.c);

const unique #file^z?3A?5Cinvariantsynthesis?5Cvcdryad?5Cvcc?5Chost?5Cbin?5Ctests?5Ctraverse?2Dtree?5Cdryad_pretree.h: $token;

axiom $file_name_is(1, #file^z?3A?5Cinvariantsynthesis?5Cvcdryad?5Cvcc?5Chost?5Cbin?5Ctests?5Ctraverse?2Dtree?5Cdryad_pretree.h);
