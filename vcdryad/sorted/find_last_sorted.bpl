  ...
  anon7:
    ...
    if ($non_null($phys_ptr_cast(L#curr, ^s_node)))
    {
      anon4:
        ...
        assume true;
        while (true)
          invariant F#srtl($s, $phys_ptr_cast(P#l, ^s_node));
          invariant F#srtl($s, $phys_ptr_cast(L#curr, ^s_node));
          invariant F#srtl_lseg($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node));
          invariant $oset_disjoint(F#srtl_lseg_reach($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)), F#srtl_reach($s, $phys_ptr_cast(L#curr, ^s_node)));
          invariant $intset_in($rd_inv($s, s_node.key, $phys_ptr_cast(P#l, ^s_node)), F#sll_keys($s, $phys_ptr_cast(P#l, ^s_node)));
          invariant $non_null($phys_ptr_cast(P#l, ^s_node));
          ...
          invariant F#sll_keys($s, $phys_ptr_cast(P#l, ^s_node)) == $intset_union($intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(P#l, ^s_node))), F#sll_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node)));
        {
          anon3:
...
const unique #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Csorted?5Cfind_last_sorted.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Csorted?5Cfind_last_sorted.c);

const unique #file^z?3A?5Cinvariantsynthesis?5Csubmit?5Csorted?5Cdryad_srtl.h: $token;

axiom $file_name_is(1, #file^z?3A?5Cinvariantsynthesis?5Csubmit?5Csorted?5Cdryad_srtl.h);
