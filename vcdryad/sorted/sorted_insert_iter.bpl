...
const unique ^$#sorted_insert_iter.c..36263#3: $ctype;

axiom $def_fnptr_type(^$#sorted_insert_iter.c..36263#3);

type $#sorted_insert_iter.c..36263#3;
...
implementation sorted_insert_iter(P#l: $ptr, P#k: int) returns ($result: $ptr)
{
  ...
  anon12:
    ...
    assume $non_null($phys_ptr_cast(P#l, ^s_node)) ==> $mutable($s, $phys_ptr_cast(P#l, ^s_node)) && $top_writable($s, #wrTime$3^3.3, $phys_ptr_cast(P#l, ^s_node));
    assume true;
    ...
    if ($is_null($phys_ptr_cast(P#l, ^s_node)))
    {
      anon1:
        ...
        assume $full_stop_ext(#tok$3^13.15, $s);
        ...
        assert $writable_prim($s, #wrTime$3^3.3, $dot($phys_ptr_cast(L#tl, ^s_node), s_node.key));
        // *(tl->key) := k; 
        ...
        assert $writable_prim($s, #wrTime$3^3.3, $dot($phys_ptr_cast(L#tl, ^s_node), s_node.next));
      ...
      anon11:
        ...
        if (P#k <= $rd_inv($s, s_node.key, $phys_ptr_cast(P#l, ^s_node)))
        {
          anon2:
            ...
            assume $full_stop_ext(#tok$3^23.16, $s);
            ...
            assume $full_stop_ext(#tok$3^26.4, $s);
        ...
        else
        {
          anon9:
            ...
            assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $non_null($rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node)) ==> $mutable($s, $phys_ptr_cast(P#l, ^s_node)) == $mutable($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node)) && $top_writable($s, #wrTime$3^3.3, $phys_ptr_cast(P#l, ^s_node)) == $top_writable($s, #wrTime$3^3.3, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node));
            // prev := l; 
            ...
            while (true)
              ...
              invariant $non_null($phys_ptr_cast(L#next, ^s_node)) ==> $top_writable($s, #wrTime$3^3.3, $phys_ptr_cast(L#next, ^s_node));
              invariant $non_null($phys_ptr_cast(L#prev, ^s_node)) ==> $mutable($s, $phys_ptr_cast(L#prev, ^s_node));
              invariant $non_null($phys_ptr_cast(L#prev, ^s_node)) ==> $top_writable($s, #wrTime$3^3.3, $phys_ptr_cast(L#prev, ^s_node));
            {
              anon7:
                assume $writes_nothing(old($s), $s);
                assume $timestamp_post(loopState#0, $s);
                assume $full_stop_ext(#tok$3^36.4, $s);
              ...
              anon8:
                ...
                if (ite#1)
                {
                  anon5:
                    ...
                    assume $non_null($phys_ptr_cast(L#next, ^s_node)) && $non_null($rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#next, ^s_node), ^s_node)) ==> $mutable($s, $phys_ptr_cast(L#next, ^s_node)) == $mutable($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#next, ^s_node), ^s_node)) && $top_writable($s, #wrTime$3^3.3, $phys_ptr_cast(L#next, ^s_node)) == $top_writable($s, #wrTime$3^3.3, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#next, ^s_node), ^s_node));
                    // prev := next; 
          ...
          #break_2:
            ...
            assume $full_stop_ext(#tok$3^59.18, $s);
            ...
            assume $full_stop_ext(#tok$3^61.7, $s);
            ...
            assert $writable_prim($s, #wrTime$3^3.3, $dot($phys_ptr_cast(L#curr, ^s_node), s_node.key));
            // *(curr->key) := k; 
            call $write_int(s_node.key, $phys_ptr_cast(L#curr, ^s_node), P#k);
            assume $full_stop_ext(#tok$3^62.4, $s);
            ...
            assert $writable_prim($s, #wrTime$3^3.3, $dot($phys_ptr_cast(L#prev, ^s_node), s_node.next));
            // *(prev->next) := curr; 
...
const unique #tok$3^62.4: $token;

const unique #tok$3^61.7: $token;

const unique #tok$3^59.18: $token;

const unique #tok$3^36.4: $token;

const unique #tok$3^27.4: $token;

const unique #tok$3^26.4: $token;

const unique #tok$3^23.16: $token;

const unique #tok$3^17.3: $token;

const unique #tok$3^16.3: $token;

const unique #tok$3^13.15: $token;
...
const unique #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Csorted?5Csorted_insert_iter.c: $token;

axiom $file_name_is(3, #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Csorted?5Csorted_insert_iter.c);

const unique #file^z?3A?5Cinvariantsynthesis?5Csubmit?5Csorted?5Cdryad_srtl.h: $token;

axiom $file_name_is(2, #file^z?3A?5Cinvariantsynthesis?5Csubmit?5Csorted?5Cdryad_srtl.h);
