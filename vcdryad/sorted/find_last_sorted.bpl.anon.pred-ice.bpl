...
const unique ^$#find_last_sorted.c..36263#3: $ctype;

axiom $def_fnptr_type(^$#find_last_sorted.c..36263#3);

type $#find_last_sorted.c..36263#3;
...
procedure find_last_sorted(P#l: $ptr) returns ($result: $ptr);
  requires F#srtl($s, $phys_ptr_cast(P#l, ^s_node));
  modifies $s, $cev_pc;
  ensures F#srtl($s, $phys_ptr_cast(P#l, ^s_node));
  ensures F#srtl_lseg($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast($result, ^s_node)) && $oset_disjoint(F#srtl_lseg_reach($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast($result, ^s_node)), F#srtl_reach($s, $phys_ptr_cast($result, ^s_node)));
  ensures F#srtl($s, $phys_ptr_cast($result, ^s_node));
  ensures $is_null($phys_ptr_cast($result, ^s_node)) || $is_null($rd_phys_ptr($s, s_node.next, $phys_ptr_cast($result, ^s_node), ^s_node));
  free ensures $writes_nothing(old($s), $s);
  free ensures $call_transition(old($s), $s);



implementation find_last_sorted(P#l: $ptr) returns ($result: $ptr)
{
  var stmtexpr0#2: $ptr;
  var SL#curr0: $ptr;
...
// INV:LST: srtl
  ...
  anon7:
    ...
    // curr := l; 
    L#curr := $phys_ptr_cast(P#l, ^s_node);
...
p0002 := (F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)));
p0003 := (F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)));
p0004 := ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0005 := ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node))));
p0006 := ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0007 := ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node))));
p0008 := (($non_null($phys_ptr_cast(P#l,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
p0009 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))));
...
p0014 := (($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#curr,^s_node)));
p0015 := (($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#l,^s_node)));
...
p0020 := (($non_null($phys_ptr_cast(P#l,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node) == $phys_ptr_cast(L#curr,^s_node))));
p0021 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node) == $phys_ptr_cast(P#l,^s_node))));
p0022 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
p0023 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))));
p0024 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0025 := ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0026 := ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
p0027 := ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
p0028 := ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0029 := ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0030 := ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0031 := ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0032 := (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0033 := (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0034 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
p0035 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)))));
p0036 := (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node)))));
p0037 := (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
p0038 := (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0039 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)))));

        while (true)

invariant (p0000 == (F#srtl($s,$phys_ptr_cast(P#l,^s_node))));
invariant (p0001 == (F#srtl($s,$phys_ptr_cast(L#curr,^s_node))));
invariant (p0002 == (F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant (p0003 == (F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node))));
invariant (p0004 == ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0005 == ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))));
invariant (p0006 == ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0007 == ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))));
invariant (p0008 == (($non_null($phys_ptr_cast(P#l,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0009 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node))))));
...
invariant (p0014 == (($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant (p0015 == (($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#l,^s_node))));
...
invariant (p0020 == (($non_null($phys_ptr_cast(P#l,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node) == $phys_ptr_cast(L#curr,^s_node)))));
invariant (p0021 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node) == $phys_ptr_cast(P#l,^s_node)))));
invariant (p0022 == ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0023 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)))));
invariant (p0024 == ((F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0025 == ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0026 == ((F#sll_keys($s,$phys_ptr_cast(P#l,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#l,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0027 == ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0028 == ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0029 == ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0030 == ((($non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0031 == ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0032 == (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0033 == (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0034 == (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0035 == (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0036 == (((F#srtl($s,$phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#l,^s_node))))));
invariant (p0037 == (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0038 == (((F#srtl_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#l,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0039 == (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node))))));
...
true
          ...
          invariant $non_null($phys_ptr_cast(P#l, ^s_node)) ==> $mutable($s, $phys_ptr_cast(P#l, ^s_node));
          invariant $non_null($phys_ptr_cast(P#l, ^s_node)) ==> $top_writable($s, #wrTime$2^3.3, $phys_ptr_cast(P#l, ^s_node));
        {
          anon3:
            assume $writes_nothing(old($s), $s);
            assume $timestamp_post(loopState#0, $s);
            assume $full_stop_ext(#tok$2^23.4, $s);
            ...
            if ($non_null($rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#curr, ^s_node), ^s_node)))
            {
              anon1:
                ...
                // assume ==>(@_vcc_ptr_neq_null(l), ==(srtl_reach(l), @_vcc_oset_union(srtl_reach(*((l->next))), @_vcc_oset_singleton(l)))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) ==> F#srtl_reach($s, $phys_ptr_cast(P#l, ^s_node)) == $oset_union(F#srtl_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node)), $oset_singleton($phys_ptr_cast(P#l, ^s_node)));
                // assume ==>(&&(@_vcc_ptr_neq_null(l), @_vcc_ptr_neq_pure(l, curr)), ==(sll_lseg(l, curr), &&(sll_lseg(*((l->next)), curr), unchecked!(@_vcc_oset_in(l, sll_lseg_reach(*((l->next)), curr)))))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $phys_ptr_cast(P#l, ^s_node) != $phys_ptr_cast(L#curr, ^s_node) ==> F#sll_lseg($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)) == (F#sll_lseg($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)) && !$oset_in($phys_ptr_cast(P#l, ^s_node), F#sll_lseg_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node))));
                // assume ==>(&&(@_vcc_ptr_neq_null(l), @_vcc_ptr_neq_pure(l, curr)), ==(sll_lseg_reach(l, curr), @_vcc_oset_union(sll_lseg_reach(*((l->next)), curr), @_vcc_oset_singleton(l)))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $phys_ptr_cast(P#l, ^s_node) != $phys_ptr_cast(L#curr, ^s_node) ==> F#sll_lseg_reach($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)) == $oset_union(F#sll_lseg_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)), $oset_singleton($phys_ptr_cast(P#l, ^s_node)));
                // assume ==>(&&(@_vcc_ptr_neq_null(l), @_vcc_ptr_neq_pure(l, curr)), ==(sll_lseg_keys(l, curr), @_vcc_intset_union(sll_lseg_keys(*((l->next)), curr), @_vcc_intset_singleton(*((l->key)))))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $phys_ptr_cast(P#l, ^s_node) != $phys_ptr_cast(L#curr, ^s_node) ==> F#sll_lseg_keys($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)) == $intset_union(F#sll_lseg_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)), $intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(P#l, ^s_node))));
                // assume ==>(&&(@_vcc_ptr_neq_null(l), @_vcc_ptr_neq_pure(l, curr)), ==(sll_lseg_len_next(l, curr), unchecked+(sll_lseg_len_next(*((l->next)), curr), 1))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $phys_ptr_cast(P#l, ^s_node) != $phys_ptr_cast(L#curr, ^s_node) ==> F#sll_lseg_len_next($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)) == $unchk_add(^^nat, F#sll_lseg_len_next($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)), 1);
                // assume ==>(&&(&&(@_vcc_ptr_neq_null(l), @_vcc_ptr_neq_pure(l, curr)), @_vcc_ptr_neq_pure(*((l->next)), curr)), ==(sll_lseg_max_key(l, curr), @\int_max(*((l->key)), sll_lseg_max_key(*((l->next)), curr)))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $phys_ptr_cast(P#l, ^s_node) != $phys_ptr_cast(L#curr, ^s_node) && $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node) != $phys_ptr_cast(L#curr, ^s_node) ==> F#sll_lseg_max_key($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)) == $int_max($rd_inv($s, s_node.key, $phys_ptr_cast(P#l, ^s_node)), F#sll_lseg_max_key($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)));
                // assume ==>(&&(&&(@_vcc_ptr_neq_null(l), @_vcc_ptr_neq_pure(l, curr)), @_vcc_ptr_neq_pure(*((l->next)), curr)), ==(sll_lseg_min_key(l, curr), @\int_min(*((l->key)), sll_lseg_min_key(*((l->next)), curr)))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $phys_ptr_cast(P#l, ^s_node) != $phys_ptr_cast(L#curr, ^s_node) && $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node) != $phys_ptr_cast(L#curr, ^s_node) ==> F#sll_lseg_min_key($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)) == $int_min($rd_inv($s, s_node.key, $phys_ptr_cast(P#l, ^s_node)), F#sll_lseg_min_key($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)));
                // assume ==>(&&(&&(@_vcc_ptr_neq_null(l), @_vcc_ptr_neq_pure(l, curr)), @_vcc_ptr_neq_pure(*((l->next)), curr)), ==(srtl_lseg(l, curr), &&(&&(srtl_lseg(*((l->next)), curr), unchecked!(@_vcc_oset_in(l, srtl_lseg_reach(*((l->next)), curr)))), <=(*((l->key)), sll_lseg_min_key(*((l->next)), curr))))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $phys_ptr_cast(P#l, ^s_node) != $phys_ptr_cast(L#curr, ^s_node) && $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node) != $phys_ptr_cast(L#curr, ^s_node) ==> F#srtl_lseg($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)) == (F#srtl_lseg($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)) && !$oset_in($phys_ptr_cast(P#l, ^s_node), F#srtl_lseg_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node))) && $rd_inv($s, s_node.key, $phys_ptr_cast(P#l, ^s_node)) <= F#sll_lseg_min_key($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)));
                // assume ==>(&&(@_vcc_ptr_neq_null(l), @_vcc_ptr_neq_pure(l, curr)), ==(srtl_lseg_reach(l, curr), @_vcc_oset_union(srtl_lseg_reach(*((l->next)), curr), @_vcc_oset_singleton(l)))); 
                assume $non_null($phys_ptr_cast(P#l, ^s_node)) && $phys_ptr_cast(P#l, ^s_node) != $phys_ptr_cast(L#curr, ^s_node) ==> F#srtl_lseg_reach($s, $phys_ptr_cast(P#l, ^s_node), $phys_ptr_cast(L#curr, ^s_node)) == $oset_union(F#srtl_lseg_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(P#l, ^s_node), ^s_node), $phys_ptr_cast(L#curr, ^s_node)), $oset_singleton($phys_ptr_cast(P#l, ^s_node)));
                // struct s_node* curr0; 
                // curr0 := curr; 
...
p0039 := (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#l,^s_node)) && $non_null($phys_ptr_cast(P#l,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#l,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#l,^s_node)))));
  ...
  anon8:
    // return curr; 
    $result := $phys_ptr_cast(L#curr, ^s_node);
    assume true;
...
axiom (forall Q#__vcc_state$1^687.9#tc2#1637: $state, Q#x$1^687.9#dt1#1617: $ptr :: {:weight 10} { F#srtl(Q#__vcc_state$1^687.9#tc2#1637, $phys_ptr_cast(Q#x$1^687.9#dt1#1617, ^s_node)) } { F#sll(Q#__vcc_state$1^687.9#tc2#1637, $phys_ptr_cast(Q#x$1^687.9#dt1#1617, ^s_node)) } $good_state(Q#__vcc_state$1^687.9#tc2#1637) && true ==> F#srtl(Q#__vcc_state$1^687.9#tc2#1637, $phys_ptr_cast(Q#x$1^687.9#dt1#1617, ^s_node)) ==> F#sll(Q#__vcc_state$1^687.9#tc2#1637, $phys_ptr_cast(Q#x$1^687.9#dt1#1617, ^s_node)));

axiom (forall Q#__vcc_state$1^688.9#tc2#1638: $state, Q#x$1^688.9#dt1#1618: $ptr :: {:weight 10} { F#rsrtl(Q#__vcc_state$1^688.9#tc2#1638, $phys_ptr_cast(Q#x$1^688.9#dt1#1618, ^s_node)) } { F#sll(Q#__vcc_state$1^688.9#tc2#1638, $phys_ptr_cast(Q#x$1^688.9#dt1#1618, ^s_node)) } $good_state(Q#__vcc_state$1^688.9#tc2#1638) && true ==> F#rsrtl(Q#__vcc_state$1^688.9#tc2#1638, $phys_ptr_cast(Q#x$1^688.9#dt1#1618, ^s_node)) ==> F#sll(Q#__vcc_state$1^688.9#tc2#1638, $phys_ptr_cast(Q#x$1^688.9#dt1#1618, ^s_node)));

axiom (forall Q#__vcc_state$1^689.9#tc2#1639: $state, Q#x$1^689.9#dt1#1619: $ptr :: {:weight 10} { F#sll_reach(Q#__vcc_state$1^689.9#tc2#1639, $phys_ptr_cast(Q#x$1^689.9#dt1#1619, ^s_node)) } { F#srtl_reach(Q#__vcc_state$1^689.9#tc2#1639, $phys_ptr_cast(Q#x$1^689.9#dt1#1619, ^s_node)) } $good_state(Q#__vcc_state$1^689.9#tc2#1639) && true ==> F#sll_reach(Q#__vcc_state$1^689.9#tc2#1639, $phys_ptr_cast(Q#x$1^689.9#dt1#1619, ^s_node)) == F#srtl_reach(Q#__vcc_state$1^689.9#tc2#1639, $phys_ptr_cast(Q#x$1^689.9#dt1#1619, ^s_node)));

axiom (forall Q#__vcc_state$1^690.9#tc2#1640: $state, Q#x$1^690.9#dt1#1620: $ptr :: {:weight 10} { F#srtl_reach(Q#__vcc_state$1^690.9#tc2#1640, $phys_ptr_cast(Q#x$1^690.9#dt1#1620, ^s_node)) } { F#rsrtl_reach(Q#__vcc_state$1^690.9#tc2#1640, $phys_ptr_cast(Q#x$1^690.9#dt1#1620, ^s_node)) } $good_state(Q#__vcc_state$1^690.9#tc2#1640) && true ==> F#srtl_reach(Q#__vcc_state$1^690.9#tc2#1640, $phys_ptr_cast(Q#x$1^690.9#dt1#1620, ^s_node)) == F#rsrtl_reach(Q#__vcc_state$1^690.9#tc2#1640, $phys_ptr_cast(Q#x$1^690.9#dt1#1620, ^s_node)));

axiom (forall Q#__vcc_state$1^691.9#tc2#1641: $state, Q#x$1^691.9#dt1#1621: $ptr, Q#y$1^691.9#dt1#1622: $ptr :: {:weight 10} { F#sll_lseg_reach(Q#__vcc_state$1^691.9#tc2#1641, $phys_ptr_cast(Q#x$1^691.9#dt1#1621, ^s_node), $phys_ptr_cast(Q#y$1^691.9#dt1#1622, ^s_node)) } { F#srtl_lseg_reach(Q#__vcc_state$1^691.9#tc2#1641, $phys_ptr_cast(Q#x$1^691.9#dt1#1621, ^s_node), $phys_ptr_cast(Q#y$1^691.9#dt1#1622, ^s_node)) } $good_state(Q#__vcc_state$1^691.9#tc2#1641) && true ==> F#sll_lseg_reach(Q#__vcc_state$1^691.9#tc2#1641, $phys_ptr_cast(Q#x$1^691.9#dt1#1621, ^s_node), $phys_ptr_cast(Q#y$1^691.9#dt1#1622, ^s_node)) == F#srtl_lseg_reach(Q#__vcc_state$1^691.9#tc2#1641, $phys_ptr_cast(Q#x$1^691.9#dt1#1621, ^s_node), $phys_ptr_cast(Q#y$1^691.9#dt1#1622, ^s_node)));

const unique l#public: $label;

axiom $type_code_is(2, ^$#state_t);

const unique #tok$2^23.4: $token;
...
const unique #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Csorted?2Dsll?5Cfind_last_sorted.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Csorted?2Dsll?5Cfind_last_sorted.c);
