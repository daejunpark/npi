...
p0008 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0009 := ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node))));
...
invariant (p0008 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0009 == ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#l,^s_node)))));
