...
ensures b0000 ==> (F#dll($s,$phys_ptr_cast(P#curr,^mem_reg)));
ensures b0001 ==> (F#dll($s,$phys_ptr_cast($result,^mem_reg)));
ensures b0002 ==> (((F#dll($s,$phys_ptr_cast(P#curr,^mem_reg)) && F#dll($s,$phys_ptr_cast($result,^mem_reg))) ==> $oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#curr,^mem_reg)),F#dll_reach($s,$phys_ptr_cast($result,^mem_reg)))));
ensures b0003 ==> (((F#dll($s,$phys_ptr_cast($result,^mem_reg)) && F#dll($s,$phys_ptr_cast(P#curr,^mem_reg))) ==> $oset_disjoint(F#dll_reach($s,$phys_ptr_cast($result,^mem_reg)),F#dll_reach($s,$phys_ptr_cast(P#curr,^mem_reg)))));
ensures b0004 ==> ((F#dll($s,$phys_ptr_cast($result,^mem_reg)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#curr,^mem_reg)),F#dll_reach($s,$phys_ptr_cast($result,^mem_reg)))));
ensures b0005 ==> ((F#dll($s,$phys_ptr_cast(P#curr,^mem_reg)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast($result,^mem_reg)),F#dll_reach($s,$phys_ptr_cast(P#curr,^mem_reg)))));
ensures b0006 ==> ($non_null($phys_ptr_cast(P#curr,^mem_reg)));
ensures b0007 ==> ($non_null($phys_ptr_cast($result,^mem_reg)));
ensures b0008 ==> ($is_null($phys_ptr_cast(P#curr,^mem_reg)));
ensures b0009 ==> ($is_null($phys_ptr_cast($result,^mem_reg)));
ensures b0010 ==> (($phys_ptr_cast(P#curr,^mem_reg) == $phys_ptr_cast($result,^mem_reg)));
ensures b0011 ==> (($phys_ptr_cast($result,^mem_reg) == $phys_ptr_cast(P#curr,^mem_reg)));
ensures b0012 ==> (($non_null($phys_ptr_cast(P#curr,^mem_reg)) ==> $non_null($rd_phys_ptr($s,mem_reg.next,$phys_ptr_cast(P#curr,^mem_reg),^mem_reg))));
ensures b0013 ==> (($non_null($phys_ptr_cast($result,^mem_reg)) ==> $non_null($rd_phys_ptr($s,mem_reg.next,$phys_ptr_cast($result,^mem_reg),^mem_reg))));
ensures b0014 ==> (($non_null($phys_ptr_cast(P#curr,^mem_reg)) ==> $is_null($rd_phys_ptr($s,mem_reg.next,$phys_ptr_cast(P#curr,^mem_reg),^mem_reg))));
ensures b0015 ==> (($non_null($phys_ptr_cast($result,^mem_reg)) ==> $is_null($rd_phys_ptr($s,mem_reg.next,$phys_ptr_cast($result,^mem_reg),^mem_reg))));
ensures b0016 ==> (($non_null($phys_ptr_cast(P#curr,^mem_reg)) ==> ($rd_phys_ptr($s,mem_reg.next,$phys_ptr_cast(P#curr,^mem_reg),^mem_reg) == $phys_ptr_cast($result,^mem_reg))));
ensures b0017 ==> (($non_null($phys_ptr_cast($result,^mem_reg)) ==> ($rd_phys_ptr($s,mem_reg.next,$phys_ptr_cast($result,^mem_reg),^mem_reg) == $phys_ptr_cast(P#curr,^mem_reg))));
ensures b0018 ==> (($non_null($phys_ptr_cast(P#curr,^mem_reg)) ==> $non_null($rd_phys_ptr($s,mem_reg.prev,$phys_ptr_cast(P#curr,^mem_reg),^mem_reg))));
ensures b0019 ==> (($non_null($phys_ptr_cast($result,^mem_reg)) ==> $non_null($rd_phys_ptr($s,mem_reg.prev,$phys_ptr_cast($result,^mem_reg),^mem_reg))));
ensures b0020 ==> (($non_null($phys_ptr_cast(P#curr,^mem_reg)) ==> $is_null($rd_phys_ptr($s,mem_reg.prev,$phys_ptr_cast(P#curr,^mem_reg),^mem_reg))));
ensures b0021 ==> (($non_null($phys_ptr_cast($result,^mem_reg)) ==> $is_null($rd_phys_ptr($s,mem_reg.prev,$phys_ptr_cast($result,^mem_reg),^mem_reg))));
ensures b0022 ==> (($non_null($phys_ptr_cast(P#curr,^mem_reg)) ==> ($rd_phys_ptr($s,mem_reg.prev,$phys_ptr_cast(P#curr,^mem_reg),^mem_reg) == $phys_ptr_cast($result,^mem_reg))));
ensures b0023 ==> (($non_null($phys_ptr_cast($result,^mem_reg)) ==> ($rd_phys_ptr($s,mem_reg.prev,$phys_ptr_cast($result,^mem_reg),^mem_reg) == $phys_ptr_cast(P#curr,^mem_reg))));

  free ensures $writes_nothing(old($s), $s);
  free ensures $call_transition(old($s), $s);

// INV:PTR: P#curr; $result
// INV:INT: P#offset
// INV:LST: dll
...
implementation split_memory_region(P#curr: $ptr, P#offset: int) returns ($result: $ptr)
{
  ...
  anon14:
    ...
    if (P#offset > $rd_inv($s, mem_reg.file_size, $phys_ptr_cast(P#curr, ^mem_reg)))
    {
      anon9:
        ...
        assume $full_stop_ext(#tok$3^22.12, $s);
        ...
        assume $full_stop_ext(#tok$3^32.5, $s);
    ...
    else
    {
      anon10:
        ...
        // next := _vcc_alloc(@_vcc_typeof((struct mem_reg*)@null)); 
        call L#next := $alloc(^mem_reg);
        assume $full_stop_ext(#tok$3^35.12, $s);
        // assume !(@_vcc_oset_in(next, @_vcc_oset_union(_dryad_G0, _dryad_G1))); 
        assume !$oset_in($phys_ptr_cast(L#next, ^mem_reg), $oset_union(SL#_dryad_G0, SL#_dryad_G1));
        // _dryad_G1 := @_vcc_oset_union(_dryad_G0, @_vcc_oset_singleton(next)); 
        SL#_dryad_G1 := $oset_union(SL#_dryad_G0, $oset_singleton($phys_ptr_cast(L#next, ^mem_reg)));
  ...
  anon15:
    ...
    if ($non_null($phys_ptr_cast(L#old_next, ^mem_reg)))
    {
      anon11:
        ...
        assume $full_stop_ext(#tok$3^57.5, $s);
  ...
  anon16:
    ...
    assume $full_stop_ext(#tok$3^59.3, $s);
...
const unique #tok$3^59.3: $token;

const unique #tok$3^57.5: $token;
...
const unique #tok$3^35.12: $token;

const unique #tok$3^33.5: $token;

const unique #tok$3^32.5: $token;
...
const unique #tok$3^22.12: $token;
...
const unique #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cmem?2Dregion?5Csplit_memory_region.c: $token;

axiom $file_name_is(3, #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cmem?2Dregion?5Csplit_memory_region.c);
