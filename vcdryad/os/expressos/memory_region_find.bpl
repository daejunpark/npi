...
implementation memory_region_find(P#head: $ptr, P#address: int) returns ($result: $ptr)
{
  ...
  anon16:
    ...
    assume true;
    while (true)
      invariant F#dll($s, $phys_ptr_cast(L#h, ^mem_reg));
    {
      anon15:
...
const unique #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Cos?5Cexpressos?5Cmemory_region_find.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Cos?5Cexpressos?5Cmemory_region_find.c);
