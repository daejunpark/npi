...
ensures b0000 ==> (F#sll($s,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)));
ensures b0001 ==> (F#sll($s,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)));
ensures b0002 ==> (((F#sll($s,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)) && F#sll($s,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)),F#sll_reach($s,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)))));
ensures b0003 ==> (((F#sll($s,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)) && F#sll($s,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)),F#sll_reach($s,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)))));
ensures b0004 ==> ((F#sll($s,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)),F#sll_reach($s,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)))));
ensures b0005 ==> ((F#sll($s,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)),F#sll_reach($s,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)))));
ensures b0006 ==> ($non_null($phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)));
ensures b0007 ==> ($non_null($phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)));
ensures b0008 ==> ($is_null($phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)));
ensures b0009 ==> ($is_null($phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)));
ensures b0010 ==> (($phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node) == $phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)));
ensures b0011 ==> (($phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node) == $phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)));
ensures b0012 ==> (($non_null($phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)) ==> $non_null($rd_phys_ptr($s,q_node.next,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node),^q_node))));
ensures b0013 ==> (($non_null($phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)) ==> $non_null($rd_phys_ptr($s,q_node.next,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node),^q_node))));
ensures b0014 ==> (($non_null($phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)) ==> $is_null($rd_phys_ptr($s,q_node.next,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node),^q_node))));
ensures b0015 ==> (($non_null($phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)) ==> $is_null($rd_phys_ptr($s,q_node.next,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node),^q_node))));
ensures b0016 ==> (($non_null($phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node)) ==> ($rd_phys_ptr($s,q_node.next,$phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node),^q_node) == $phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node))));
ensures b0017 ==> (($non_null($phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node)) ==> ($rd_phys_ptr($s,q_node.next,$phys_ptr_cast($rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node),^q_node),^q_node) == $phys_ptr_cast($rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node),^q_node))));

  free ensures $writes_nothing(old($s), $s);
  free ensures $call_transition(old($s), $s);

// P#head, $result
// INV:PTR: $rd_phys_ptr(old($s),q_head.first,$phys_ptr_cast(P#head,^q_head),^q_node); $rd_phys_ptr($s,q_head.first,$phys_ptr_cast($result,^q_head),^q_node)
// INV:INT:
// INV:LST: sll
...
const unique #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cbsd?2Dsqueue?5Cbsd_squeue_remove_head.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cbsd?2Dsqueue?5Cbsd_squeue_remove_head.c);

const unique #file^z?3A?5Cinvariantsynthesis?5Cvcdryad?5Cvcc?5Chost?5Cbin?5Ctests?5Cbsd?2Dsqueue?5Cdryad_bsd_queue.h: $token;

axiom $file_name_is(1, #file^z?3A?5Cinvariantsynthesis?5Cvcdryad?5Cvcc?5Chost?5Cbin?5Ctests?5Cbsd?2Dsqueue?5Cdryad_bsd_queue.h);
