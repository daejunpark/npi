...
invariant b0125 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.h,^s_node)))));
invariant b0126 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0127 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0128 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#t,^s_node)))));
invariant b0129 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0130 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0131 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0132 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#t,^s_node)))));
invariant b0133 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0134 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.h,^s_node)))));
invariant b0135 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0136 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#t,^s_node)))));
invariant b0137 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0138 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.h,^s_node)))));
invariant b0139 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0140 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#t,^s_node)))));
invariant b0141 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0142 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.h,^s_node)))));
invariant b0143 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0144 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0145 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0146 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0147 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0148 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0149 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0150 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0151 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0152 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0153 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0154 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0155 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0156 ==> (($non_null($phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0157 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0158 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0159 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0160 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0161 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0162 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0163 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0164 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0165 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0166 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0167 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0168 ==> (($non_null($phys_ptr_cast(local.h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0169 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0170 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0171 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0172 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0173 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0174 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0175 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0176 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0177 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0178 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0179 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0180 ==> (($non_null($phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0181 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0182 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0183 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0184 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0185 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0186 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0187 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0188 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0189 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#t,^s_node)))));
invariant b0190 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0191 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0192 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#t,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0193 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0194 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0195 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0196 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0197 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0198 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0199 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0200 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0201 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0202 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0203 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(local.h,^s_node)))));
invariant b0204 ==> (($non_null($phys_ptr_cast(L#t,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#t,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))));
