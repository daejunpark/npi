...
invariant b0000 ==> (F#sll($s,$phys_ptr_cast(L#h,^s_node)));
invariant b0001 ==> ($non_null($phys_ptr_cast(L#h,^s_node)));
invariant b0002 ==> ($is_null($phys_ptr_cast(L#h,^s_node)));
invariant b0003 ==> (($non_null($phys_ptr_cast(L#h,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#h,^s_node),^s_node))));
invariant b0004 ==> (($non_null($phys_ptr_cast(L#h,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#h,^s_node),^s_node))));
