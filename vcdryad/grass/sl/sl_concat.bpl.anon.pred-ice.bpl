...
p0000 := (F#sll($s,$phys_ptr_cast(P#a,^s_node)));
p0001 := (F#sll($s,$phys_ptr_cast(P#b,^s_node)));
p0002 := (F#sll($s,$phys_ptr_cast(L#curr,^s_node)));
p0003 := (F#sll_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)));
p0004 := (F#sll_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)));
p0005 := (F#sll_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)));
p0006 := (F#sll_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)));
p0007 := (F#sll_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)));
p0008 := (F#sll_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)));
p0009 := ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node))));
p0010 := ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0011 := ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node))));
p0012 := ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0013 := ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node))));
p0014 := ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node))));
p0015 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node))));
p0016 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0017 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node))));
p0018 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0019 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node))));
p0020 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node))));
p0021 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0022 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node))));
p0023 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0024 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node))));
p0025 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node))));
p0026 := ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node))));
p0027 := (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)))));
p0028 := (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
p0029 := (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)))));
p0030 := (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
p0031 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)))));
p0032 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)))));
p0033 := (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0034 := (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))));
p0035 := (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0036 := (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))));
p0037 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))));
p0038 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))));
...
invariant (p0000 == (F#sll($s,$phys_ptr_cast(P#a,^s_node))));
invariant (p0001 == (F#sll($s,$phys_ptr_cast(P#b,^s_node))));
invariant (p0002 == (F#sll($s,$phys_ptr_cast(L#curr,^s_node))));
invariant (p0003 == (F#sll_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))));
invariant (p0004 == (F#sll_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant (p0005 == (F#sll_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))));
invariant (p0006 == (F#sll_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant (p0007 == (F#sll_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))));
invariant (p0008 == (F#sll_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))));
invariant (p0009 == ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant (p0010 == ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0011 == ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant (p0012 == ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0013 == ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant (p0014 == ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant (p0015 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant (p0016 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0017 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant (p0018 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0019 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant (p0020 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant (p0021 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0022 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant (p0023 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0024 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant (p0025 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant (p0026 == ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant (p0027 == (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node))))));
invariant (p0028 == (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0029 == (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node))))));
invariant (p0030 == (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0031 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#a,^s_node))))));
invariant (p0032 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#b,^s_node))))));
invariant (p0033 == (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0034 == (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))))));
invariant (p0035 == (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0036 == (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))))));
invariant (p0037 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))))));
invariant (p0038 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))))));
