...
invariant b0008 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant b0009 ==> (($non_null($phys_ptr_cast(local.lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))));
