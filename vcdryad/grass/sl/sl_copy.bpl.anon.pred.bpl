...
invariant b0028 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#cp,^s_node)))));
...
invariant b0030 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#cp,^s_node)))));
invariant b0031 ==> (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0032 ==> (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0033 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#cp,^s_node)))));
invariant b0034 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0035 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#cp,^s_node)))));
invariant b0036 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0037 ==> (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0038 ==> (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
