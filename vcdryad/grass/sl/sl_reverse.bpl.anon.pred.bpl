...
invariant b0002 ==> (F#sll($s,$phys_ptr_cast(L#rev,^s_node)));
invariant b0003 ==> (F#sll_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)));
invariant b0004 ==> (F#sll_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#rev,^s_node)));
invariant b0005 ==> (F#sll_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)));
invariant b0006 ==> (F#sll_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#rev,^s_node)));
invariant b0007 ==> (F#sll_lseg($s,$phys_ptr_cast(L#rev,^s_node),$phys_ptr_cast(P#lst,^s_node)));
invariant b0008 ==> (F#sll_lseg($s,$phys_ptr_cast(L#rev,^s_node),$phys_ptr_cast(L#curr,^s_node)));
invariant b0009 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0010 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node))));
invariant b0011 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0012 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node))));
invariant b0013 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0014 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
...
invariant b0016 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#rev,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node))));
...
invariant b0018 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#rev,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node))));
invariant b0019 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#rev,^s_node),$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0020 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#rev,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0021 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node))));
invariant b0022 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#rev,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0023 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node))));
invariant b0024 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#rev,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0025 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#rev,^s_node),$phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0026 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#rev,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node))));
invariant b0027 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0028 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node)))));
invariant b0029 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0030 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#rev,^s_node)))));
invariant b0031 ==> (($non_null($phys_ptr_cast(L#rev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant b0032 ==> (($non_null($phys_ptr_cast(L#rev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0033 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#rev,^s_node)))));
invariant b0034 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#rev,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0035 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#rev,^s_node)))));
invariant b0036 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#rev,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0037 ==> (($non_null($phys_ptr_cast(L#rev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0038 ==> (($non_null($phys_ptr_cast(L#rev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
invariant b0039 ==> ($non_null($phys_ptr_cast(P#lst,^s_node)));
invariant b0040 ==> ($non_null($phys_ptr_cast(L#curr,^s_node)));
invariant b0041 ==> ($non_null($phys_ptr_cast(L#rev,^s_node)));
invariant b0042 ==> ($is_null($phys_ptr_cast(P#lst,^s_node)));
invariant b0043 ==> ($is_null($phys_ptr_cast(L#curr,^s_node)));
invariant b0044 ==> ($is_null($phys_ptr_cast(L#rev,^s_node)));
invariant b0045 ==> (($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(L#curr,^s_node)));
invariant b0046 ==> (($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(L#rev,^s_node)));
invariant b0047 ==> (($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#lst,^s_node)));
invariant b0048 ==> (($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#rev,^s_node)));
invariant b0049 ==> (($phys_ptr_cast(L#rev,^s_node) == $phys_ptr_cast(P#lst,^s_node)));
invariant b0050 ==> (($phys_ptr_cast(L#rev,^s_node) == $phys_ptr_cast(L#curr,^s_node)));
...
invariant b0053 ==> (($non_null($phys_ptr_cast(L#rev,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#rev,^s_node),^s_node))));
...
invariant b0056 ==> (($non_null($phys_ptr_cast(L#rev,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#rev,^s_node),^s_node))));
...
invariant b0058 ==> (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#lst,^s_node),^s_node) == $phys_ptr_cast(L#rev,^s_node))));
...
invariant b0060 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node) == $phys_ptr_cast(L#rev,^s_node))));
invariant b0061 ==> (($non_null($phys_ptr_cast(L#rev,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#rev,^s_node),^s_node) == $phys_ptr_cast(P#lst,^s_node))));
invariant b0062 ==> (($non_null($phys_ptr_cast(L#rev,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#rev,^s_node),^s_node) == $phys_ptr_cast(L#curr,^s_node))));
