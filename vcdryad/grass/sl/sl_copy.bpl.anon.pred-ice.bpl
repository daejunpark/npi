...
p0028 := (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#cp,^s_node)))));
...
p0030 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#cp,^s_node)))));
p0031 := (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node)))));
p0032 := (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
p0033 := (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#cp,^s_node)))));
p0034 := (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0035 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#cp,^s_node)))));
p0036 := (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
p0037 := (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
p0038 := (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node)))));
...
invariant (p0028 == (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#cp,^s_node))))));
...
invariant (p0030 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0031 == (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0032 == (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0033 == (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0034 == (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0035 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#cp,^s_node))))));
invariant (p0036 == (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#cp,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0037 == (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(L#curr,^s_node))))));
invariant (p0038 == (($non_null($phys_ptr_cast(L#cp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
