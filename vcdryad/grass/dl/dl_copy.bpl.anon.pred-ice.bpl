...
p0027 := (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
p0028 := (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)))));
p0029 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))));
p0030 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)))));
p0031 := (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))));
p0032 := (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
p0033 := (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#cp,^d_node)))));
p0034 := (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0035 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#cp,^d_node)))));
p0036 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(P#lst,^d_node)))));
p0037 := (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0038 := (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)))));
...
invariant (p0002 == (F#dll($s,$phys_ptr_cast(L#cp,^d_node))));
invariant (p0003 == (F#dll_lseg($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant (p0004 == (F#dll_lseg($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#cp,^d_node))));
invariant (p0005 == (F#dll_lseg($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node))));
invariant (p0006 == (F#dll_lseg($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#cp,^d_node))));
invariant (p0007 == (F#dll_lseg($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(P#lst,^d_node))));
invariant (p0008 == (F#dll_lseg($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(L#curr,^d_node))));
invariant (p0009 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant (p0010 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)))));
invariant (p0011 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))));
invariant (p0012 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)))));
invariant (p0013 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))));
invariant (p0014 == ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
...
invariant (p0016 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)))));
...
invariant (p0018 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)))));
invariant (p0019 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))));
invariant (p0020 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant (p0021 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)))));
invariant (p0022 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant (p0023 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node)))));
invariant (p0024 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))));
invariant (p0025 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant (p0026 == ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))));
invariant (p0027 == (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0028 == (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node))))));
invariant (p0029 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node))))));
invariant (p0030 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#cp,^d_node))))));
invariant (p0031 == (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node))))));
invariant (p0032 == (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0033 == (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#cp,^d_node))))));
invariant (p0034 == (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0035 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#cp,^d_node))))));
invariant (p0036 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#cp,^d_node),$phys_ptr_cast(P#lst,^d_node))))));
invariant (p0037 == (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0038 == (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#cp,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node))))));
invariant (p0039 == ($non_null($phys_ptr_cast(P#lst,^d_node))));
invariant (p0040 == ($non_null($phys_ptr_cast(L#curr,^d_node))));
invariant (p0041 == ($non_null($phys_ptr_cast(L#cp,^d_node))));
invariant (p0042 == ($is_null($phys_ptr_cast(P#lst,^d_node))));
invariant (p0043 == ($is_null($phys_ptr_cast(L#curr,^d_node))));
invariant (p0044 == ($is_null($phys_ptr_cast(L#cp,^d_node))));
invariant (p0045 == (($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
invariant (p0046 == (($phys_ptr_cast(P#lst,^d_node) == $phys_ptr_cast(L#cp,^d_node))));
invariant (p0047 == (($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(P#lst,^d_node))));
invariant (p0048 == (($phys_ptr_cast(L#curr,^d_node) == $phys_ptr_cast(L#cp,^d_node))));
invariant (p0049 == (($phys_ptr_cast(L#cp,^d_node) == $phys_ptr_cast(P#lst,^d_node))));
invariant (p0050 == (($phys_ptr_cast(L#cp,^d_node) == $phys_ptr_cast(L#curr,^d_node))));
...
invariant (p0053 == (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#cp,^d_node),^d_node)))));
...
invariant (p0056 == (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#cp,^d_node),^d_node)))));
...
invariant (p0058 == (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#lst,^d_node),^d_node) == $phys_ptr_cast(L#cp,^d_node)))));
...
invariant (p0060 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#curr,^d_node),^d_node) == $phys_ptr_cast(L#cp,^d_node)))));
invariant (p0061 == (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#cp,^d_node),^d_node) == $phys_ptr_cast(P#lst,^d_node)))));
invariant (p0062 == (($non_null($phys_ptr_cast(L#cp,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#cp,^d_node),^d_node) == $phys_ptr_cast(L#curr,^d_node)))));
