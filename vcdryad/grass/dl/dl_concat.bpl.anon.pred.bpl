...
invariant b0027 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))));
invariant b0028 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0029 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))));
invariant b0030 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
invariant b0031 ==> (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))));
invariant b0032 ==> (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))));
invariant b0033 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
invariant b0034 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#b,^d_node)))));
invariant b0035 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
invariant b0036 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#a,^d_node)))));
invariant b0037 ==> (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)))));
invariant b0038 ==> (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)))));
