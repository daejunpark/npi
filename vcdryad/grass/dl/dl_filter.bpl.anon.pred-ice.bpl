...
p0064 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))));
p0065 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
p0066 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))));
p0067 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))));
p0068 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
p0069 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))));
p0070 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))));
p0071 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))));
p0072 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node)))));
p0073 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node)))));
p0074 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))));
p0075 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
p0076 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0077 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)))));
p0078 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
p0079 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)))));
p0080 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
p0081 := (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0082 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0083 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)))));
p0084 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)))));
p0085 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node)))));
p0086 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)))));
p0087 := (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0088 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
p0089 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node)))));
p0090 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)))));
p0091 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node)))));
p0092 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node)))));
p0093 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
p0094 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
p0095 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0096 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node)))));
p0097 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0098 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node)))));
p0099 := (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
...
invariant (p0064 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))))));
invariant (p0065 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0066 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node))))));
invariant (p0067 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node))))));
invariant (p0068 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0069 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node))))));
invariant (p0070 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node))))));
invariant (p0071 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))))));
invariant (p0072 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#res,^d_node))))));
invariant (p0073 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#x,^d_node))))));
invariant (p0074 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))))));
invariant (p0075 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0076 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0077 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant (p0078 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant (p0079 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant (p0080 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant (p0081 == (($non_null($phys_ptr_cast(P#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0082 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0083 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant (p0084 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant (p0085 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant (p0086 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant (p0087 == (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0088 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant (p0089 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant (p0090 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant (p0091 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#res,^d_node))))));
invariant (p0092 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant (p0093 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#res,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant (p0094 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
invariant (p0095 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#x,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0096 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant (p0097 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0098 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#x,^d_node))))));
invariant (p0099 == (($non_null($phys_ptr_cast(L#res,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#prv,^d_node))))));
