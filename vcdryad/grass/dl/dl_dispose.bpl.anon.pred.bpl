...
invariant b0002 ==> (F#dll($s,$phys_ptr_cast(L#prv,^d_node)));
invariant b0003 ==> (F#dll($s,$phys_ptr_cast(local.a,^d_node)));
invariant b0004 ==> (F#dll_lseg($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)));
invariant b0005 ==> (F#dll_lseg($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)));
invariant b0006 ==> (F#dll_lseg($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)));
invariant b0007 ==> (F#dll_lseg($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)));
invariant b0008 ==> (F#dll_lseg($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)));
invariant b0009 ==> (F#dll_lseg($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)));
invariant b0010 ==> (F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)));
invariant b0011 ==> (F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)));
invariant b0012 ==> (F#dll_lseg($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)));
invariant b0013 ==> (F#dll_lseg($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)));
invariant b0014 ==> (F#dll_lseg($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)));
invariant b0015 ==> (F#dll_lseg($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)));
invariant b0016 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0017 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0018 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0019 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0020 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0021 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0022 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0023 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0024 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0025 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0026 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0027 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0028 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0029 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0030 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0031 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0032 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0033 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0034 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0035 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0036 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0037 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0038 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0039 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0040 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0041 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0042 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0043 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0044 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0045 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0046 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0047 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0048 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0049 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0050 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0051 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0052 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0053 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0054 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0055 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node))));
invariant b0056 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0057 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0058 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0059 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0060 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0061 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node))));
invariant b0062 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node))));
invariant b0063 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node))));
invariant b0064 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))));
invariant b0065 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))));
invariant b0066 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))));
invariant b0067 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))));
invariant b0068 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))));
invariant b0069 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))));
invariant b0070 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))));
invariant b0071 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))));
invariant b0072 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.a,^d_node)))));
invariant b0073 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#a,^d_node)))));
invariant b0074 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#b,^d_node)))));
invariant b0075 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#prv,^d_node)))));
invariant b0076 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
invariant b0077 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)))));
invariant b0078 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)))));
invariant b0079 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)))));
invariant b0080 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)))));
invariant b0081 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
invariant b0082 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
invariant b0083 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)))));
invariant b0084 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)))));
invariant b0085 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(local.a,^d_node)))));
invariant b0086 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)))));
invariant b0087 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
invariant b0088 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)))));
invariant b0089 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(local.a,^d_node)))));
invariant b0090 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)))));
invariant b0091 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(local.a,^d_node)))));
invariant b0092 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#a,^d_node)))));
invariant b0093 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prv,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.a,^d_node),$phys_ptr_cast(P#b,^d_node)))));
invariant b0094 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(P#b,^d_node)))));
invariant b0095 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#a,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
invariant b0096 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(P#a,^d_node)))));
invariant b0097 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#b,^d_node),$phys_ptr_cast(L#prv,^d_node)))));
invariant b0098 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#a,^d_node)))));
invariant b0099 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#prv,^d_node),$phys_ptr_cast(P#b,^d_node)))));
invariant b0100 ==> ($non_null($phys_ptr_cast(P#a,^d_node)));
invariant b0101 ==> ($non_null($phys_ptr_cast(P#b,^d_node)));
invariant b0102 ==> ($non_null($phys_ptr_cast(L#prv,^d_node)));
invariant b0103 ==> ($non_null($phys_ptr_cast(local.a,^d_node)));
invariant b0104 ==> ($is_null($phys_ptr_cast(P#a,^d_node)));
invariant b0105 ==> ($is_null($phys_ptr_cast(P#b,^d_node)));
invariant b0106 ==> ($is_null($phys_ptr_cast(L#prv,^d_node)));
invariant b0107 ==> ($is_null($phys_ptr_cast(local.a,^d_node)));
invariant b0108 ==> (($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(P#b,^d_node)));
invariant b0109 ==> (($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(L#prv,^d_node)));
invariant b0110 ==> (($phys_ptr_cast(P#a,^d_node) == $phys_ptr_cast(local.a,^d_node)));
invariant b0111 ==> (($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(P#a,^d_node)));
invariant b0112 ==> (($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(L#prv,^d_node)));
invariant b0113 ==> (($phys_ptr_cast(P#b,^d_node) == $phys_ptr_cast(local.a,^d_node)));
invariant b0114 ==> (($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#a,^d_node)));
invariant b0115 ==> (($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(P#b,^d_node)));
invariant b0116 ==> (($phys_ptr_cast(L#prv,^d_node) == $phys_ptr_cast(local.a,^d_node)));
invariant b0117 ==> (($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#a,^d_node)));
invariant b0118 ==> (($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(P#b,^d_node)));
invariant b0119 ==> (($phys_ptr_cast(local.a,^d_node) == $phys_ptr_cast(L#prv,^d_node)));
invariant b0120 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#a,^d_node),^d_node))));
invariant b0121 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#b,^d_node),^d_node))));
invariant b0122 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node))));
invariant b0123 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node))));
invariant b0124 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#a,^d_node),^d_node))));
invariant b0125 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#b,^d_node),^d_node))));
invariant b0126 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node))));
invariant b0127 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node))));
invariant b0128 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#a,^d_node),^d_node) == $phys_ptr_cast(P#b,^d_node))));
invariant b0129 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#a,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0130 ==> (($non_null($phys_ptr_cast(P#a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#a,^d_node),^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0131 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#b,^d_node),^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0132 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#b,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node))));
invariant b0133 ==> (($non_null($phys_ptr_cast(P#b,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#b,^d_node),^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0134 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0135 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(P#b,^d_node))));
invariant b0136 ==> (($non_null($phys_ptr_cast(L#prv,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(L#prv,^d_node),^d_node) == $phys_ptr_cast(local.a,^d_node))));
invariant b0137 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node) == $phys_ptr_cast(P#a,^d_node))));
invariant b0138 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node) == $phys_ptr_cast(P#b,^d_node))));
invariant b0139 ==> (($non_null($phys_ptr_cast(local.a,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.a,^d_node),^d_node) == $phys_ptr_cast(L#prv,^d_node))));
