...
p0028 := (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))));
...
p0030 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node)))));
p0031 := (($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node)))));
p0032 := (($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node)))));
p0033 := (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node)))));
p0034 := (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0035 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node)))));
p0036 := (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node)))));
p0037 := (($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node)))));
p0038 := (($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node)))));
...
invariant (p0028 == (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node))))));
...
invariant (p0030 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#rev,^d_node))))));
invariant (p0031 == (($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#lst,^d_node))))));
invariant (p0032 == (($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0033 == (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(L#rev,^d_node))))));
invariant (p0034 == (($non_null($phys_ptr_cast(P#lst,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0035 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#rev,^d_node))))));
invariant (p0036 == (($non_null($phys_ptr_cast(L#curr,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#rev,^d_node),$phys_ptr_cast(P#lst,^d_node))))));
invariant (p0037 == (($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#lst,^d_node),$phys_ptr_cast(L#curr,^d_node))))));
invariant (p0038 == (($non_null($phys_ptr_cast(L#rev,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#rev,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(L#curr,^d_node),$phys_ptr_cast(P#lst,^d_node))))));
