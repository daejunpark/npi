...
invariant b0001 ==> (F#srtl($s,$phys_ptr_cast(L#z,^s_node)));
invariant b0002 ==> (F#srtl($s,$phys_ptr_cast(L#curr,^s_node)));
invariant b0003 ==> (F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)));
invariant b0004 ==> (F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)));
invariant b0005 ==> (F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)));
invariant b0006 ==> (F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)));
invariant b0007 ==> (F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)));
invariant b0008 ==> (F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)));
invariant b0009 ==> ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0010 ==> ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0011 ==> ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0012 ==> ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0013 ==> ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0014 ==> ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0015 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0016 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0017 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0018 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0019 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0020 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0021 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0022 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0023 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0024 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0025 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0026 ==> ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0027 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0028 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0029 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#z,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0030 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#z,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0031 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0032 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0033 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0034 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node))));
invariant b0035 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#z,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0036 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#z,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0037 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node))));
invariant b0038 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0039 ==> ($non_null($phys_ptr_cast(P#x,^s_node)));
invariant b0040 ==> ($non_null($phys_ptr_cast(L#z,^s_node)));
invariant b0041 ==> ($non_null($phys_ptr_cast(L#curr,^s_node)));
invariant b0042 ==> ($is_null($phys_ptr_cast(P#x,^s_node)));
invariant b0043 ==> ($is_null($phys_ptr_cast(L#z,^s_node)));
invariant b0044 ==> ($is_null($phys_ptr_cast(L#curr,^s_node)));
invariant b0045 ==> (($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast(L#z,^s_node)));
invariant b0046 ==> (($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast(L#curr,^s_node)));
invariant b0047 ==> (($phys_ptr_cast(L#z,^s_node) == $phys_ptr_cast(P#x,^s_node)));
invariant b0048 ==> (($phys_ptr_cast(L#z,^s_node) == $phys_ptr_cast(L#curr,^s_node)));
invariant b0049 ==> (($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(P#x,^s_node)));
invariant b0050 ==> (($phys_ptr_cast(L#curr,^s_node) == $phys_ptr_cast(L#z,^s_node)));
invariant b0051 ==> (($non_null($phys_ptr_cast(P#x,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#x,^s_node),^s_node))));
invariant b0052 ==> (($non_null($phys_ptr_cast(L#z,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#z,^s_node),^s_node))));
...
invariant b0054 ==> (($non_null($phys_ptr_cast(P#x,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#x,^s_node),^s_node))));
invariant b0055 ==> (($non_null($phys_ptr_cast(L#z,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#z,^s_node),^s_node))));
...
invariant b0057 ==> (($non_null($phys_ptr_cast(P#x,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#x,^s_node),^s_node) == $phys_ptr_cast(L#z,^s_node))));
invariant b0058 ==> (($non_null($phys_ptr_cast(P#x,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#x,^s_node),^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0059 ==> (($non_null($phys_ptr_cast(L#z,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#z,^s_node),^s_node) == $phys_ptr_cast(P#x,^s_node))));
invariant b0060 ==> (($non_null($phys_ptr_cast(L#z,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#z,^s_node),^s_node) == $phys_ptr_cast(L#curr,^s_node))));
invariant b0061 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node) == $phys_ptr_cast(P#x,^s_node))));
invariant b0062 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#curr,^s_node),^s_node) == $phys_ptr_cast(L#z,^s_node))));
invariant b0063 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0064 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0065 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0066 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0067 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
invariant b0068 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#z,^s_node))));
invariant b0069 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0070 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node))));
invariant b0071 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0072 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0073 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node))));
invariant b0074 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node))));
invariant b0075 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0076 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0077 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0078 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0079 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0080 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0081 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0082 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0083 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0084 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0085 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0086 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0087 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0088 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0089 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0090 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0091 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0092 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0093 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0094 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0095 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0096 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0097 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0098 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0099 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0100 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0101 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0102 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#z,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0103 ==> ((F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0104 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0105 ==> ((($non_null($phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0106 ==> ((($non_null($phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0107 ==> ((($non_null($phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0108 ==> ((($non_null($phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0109 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0110 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0111 ==> ((($non_null($phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0112 ==> ((($non_null($phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0113 ==> ((($non_null($phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0114 ==> ((($non_null($phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0115 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0116 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0117 ==> (((F#srtl($s,$phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0118 ==> (((F#srtl($s,$phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0119 ==> (((F#srtl($s,$phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#z,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0120 ==> (((F#srtl($s,$phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#z,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0121 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0122 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0123 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)) && ($phys_ptr_cast(P#x,^s_node) != $phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0124 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#x,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0125 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)) && ($phys_ptr_cast(L#z,^s_node) != $phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0126 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#z,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0127 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0128 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0129 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)) && ($phys_ptr_cast(P#x,^s_node) != $phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0130 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#x,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0131 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)) && ($phys_ptr_cast(L#z,^s_node) != $phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0132 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#z,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0133 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)))));
invariant b0134 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
invariant b0135 ==> (((F#srtl($s,$phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0136 ==> (((F#srtl($s,$phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#x,^s_node)))));
invariant b0137 ==> (((F#srtl($s,$phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0138 ==> (((F#srtl($s,$phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#z,^s_node)))));
invariant b0139 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0140 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0141 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)) && ($phys_ptr_cast(P#x,^s_node) != $phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)))));
invariant b0142 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#x,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0143 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)) && ($phys_ptr_cast(L#z,^s_node) != $phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)))));
invariant b0144 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#z,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0145 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)))));
invariant b0146 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)))));
invariant b0147 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)) && ($phys_ptr_cast(P#x,^s_node) != $phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#z,^s_node)))));
invariant b0148 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#x,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#x,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0149 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)) && ($phys_ptr_cast(L#z,^s_node) != $phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(P#x,^s_node)))));
invariant b0150 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(L#z,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#z,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0151 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#x,^s_node)) && $non_null($phys_ptr_cast(L#z,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#z,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#x,^s_node)))));
invariant b0152 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(L#z,^s_node)) && $non_null($phys_ptr_cast(P#x,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(L#z,^s_node)))));
