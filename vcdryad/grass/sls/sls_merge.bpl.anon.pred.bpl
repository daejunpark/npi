...
invariant b0064 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#last,^s_node))));
invariant b0065 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.a,^s_node))));
invariant b0066 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.b,^s_node))));
invariant b0067 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#res,^s_node))));
invariant b0068 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.a,^s_node))));
invariant b0069 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.b,^s_node))));
invariant b0070 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#res,^s_node))));
invariant b0071 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#last,^s_node))));
invariant b0072 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.b,^s_node))));
invariant b0073 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#res,^s_node))));
invariant b0074 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#last,^s_node))));
invariant b0075 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.a,^s_node))));
invariant b0076 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.a,^s_node))));
invariant b0077 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.b,^s_node))));
invariant b0078 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.a,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0079 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.a,^s_node),$phys_ptr_cast(local.b,^s_node))));
invariant b0080 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.b,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0081 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#res,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.b,^s_node),$phys_ptr_cast(local.a,^s_node))));
invariant b0082 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(local.a,^s_node))));
invariant b0083 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(local.b,^s_node))));
invariant b0084 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.a,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0085 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.a,^s_node),$phys_ptr_cast(local.b,^s_node))));
invariant b0086 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.b,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0087 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(L#last,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.b,^s_node),$phys_ptr_cast(local.a,^s_node))));
invariant b0088 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0089 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(local.b,^s_node))));
invariant b0090 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0091 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.b,^s_node))));
invariant b0092 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.b,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0093 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.b,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0094 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(L#last,^s_node))));
invariant b0095 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#res,^s_node),$phys_ptr_cast(local.a,^s_node))));
invariant b0096 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0097 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#last,^s_node),$phys_ptr_cast(local.a,^s_node))));
invariant b0098 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.a,^s_node),$phys_ptr_cast(L#res,^s_node))));
invariant b0099 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(local.a,^s_node),$phys_ptr_cast(L#last,^s_node))));
