...
invariant b0008 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node))));
invariant b0009 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node))));
