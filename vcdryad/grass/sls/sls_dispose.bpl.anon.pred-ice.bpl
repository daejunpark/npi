...
p0001 := (F#srtl($s,$phys_ptr_cast(local.lst,^s_node)));
p0002 := (F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)));
p0003 := (F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)));
p0004 := ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node))));
p0005 := ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node))));
p0006 := ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node))));
p0007 := ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node))));
p0008 := (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node)))));
p0009 := (($non_null($phys_ptr_cast(local.lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node)))));
...
p0024 := ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
p0025 := ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
p0026 := ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
p0027 := ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
...
p0032 := (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
p0033 := (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
p0034 := (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)))));
p0035 := (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)))));
p0036 := (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#lst,^s_node)))));
p0037 := (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(local.lst,^s_node)))));
p0038 := (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)))));
p0039 := (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)))));

    while (true)

invariant (p0000 == (F#srtl($s,$phys_ptr_cast(P#lst,^s_node))));
invariant (p0001 == (F#srtl($s,$phys_ptr_cast(local.lst,^s_node))));
invariant (p0002 == (F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))));
invariant (p0003 == (F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))));
invariant (p0004 == ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant (p0005 == ($oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant (p0006 == ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant (p0007 == ($oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant (p0008 == (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0009 == (($non_null($phys_ptr_cast(local.lst,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.lst,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0010 == ($non_null($phys_ptr_cast(P#lst,^s_node))));
invariant (p0011 == ($non_null($phys_ptr_cast(local.lst,^s_node))));
invariant (p0012 == ($is_null($phys_ptr_cast(P#lst,^s_node))));
invariant (p0013 == ($is_null($phys_ptr_cast(local.lst,^s_node))));
invariant (p0014 == (($phys_ptr_cast(P#lst,^s_node) == $phys_ptr_cast(local.lst,^s_node))));
invariant (p0015 == (($phys_ptr_cast(local.lst,^s_node) == $phys_ptr_cast(P#lst,^s_node))));
invariant (p0016 == (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#lst,^s_node),^s_node)))));
invariant (p0017 == (($non_null($phys_ptr_cast(local.lst,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(local.lst,^s_node),^s_node)))));
invariant (p0018 == (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#lst,^s_node),^s_node)))));
invariant (p0019 == (($non_null($phys_ptr_cast(local.lst,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(local.lst,^s_node),^s_node)))));
invariant (p0020 == (($non_null($phys_ptr_cast(P#lst,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#lst,^s_node),^s_node) == $phys_ptr_cast(local.lst,^s_node)))));
invariant (p0021 == (($non_null($phys_ptr_cast(local.lst,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(local.lst,^s_node),^s_node) == $phys_ptr_cast(P#lst,^s_node)))));
invariant (p0022 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)))));
invariant (p0023 == ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)))));
invariant (p0024 == ((F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0025 == ((F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0026 == ((F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0027 == ((F#sll_keys($s,$phys_ptr_cast(local.lst,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.lst,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0028 == ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0029 == ((($non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0030 == ((($non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0031 == ((($non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0032 == (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0033 == (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0034 == (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0035 == (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0036 == (((F#srtl($s,$phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#lst,^s_node))))));
invariant (p0037 == (((F#srtl($s,$phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0038 == (((F#srtl_lseg($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node)) && ($phys_ptr_cast(P#lst,^s_node) != $phys_ptr_cast(local.lst,^s_node)) && $non_null($phys_ptr_cast(local.lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#lst,^s_node),$phys_ptr_cast(local.lst,^s_node))))));
invariant (p0039 == (((F#srtl_lseg($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node)) && ($phys_ptr_cast(local.lst,^s_node) != $phys_ptr_cast(P#lst,^s_node)) && $non_null($phys_ptr_cast(P#lst,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#lst,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(local.lst,^s_node),$phys_ptr_cast(P#lst,^s_node))))));
...
const unique #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cgrass?5Csls_dispose.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cgrass?5Csls_dispose.c);
