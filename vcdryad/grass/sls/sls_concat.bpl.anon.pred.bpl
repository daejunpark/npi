...
invariant b0027 ==> (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0028 ==> (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0029 ==> (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0030 ==> (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0031 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0032 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0033 ==> (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0034 ==> (($non_null($phys_ptr_cast(P#a,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))));
invariant b0035 ==> (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0036 ==> (($non_null($phys_ptr_cast(P#b,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))));
invariant b0037 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))));
invariant b0038 ==> (($non_null($phys_ptr_cast(L#curr,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))));
...
invariant b0063 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))));
invariant b0064 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0065 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))));
invariant b0066 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node))));
invariant b0067 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#a,^s_node))));
invariant b0068 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#b,^s_node))));
invariant b0069 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0070 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))));
invariant b0071 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))));
invariant b0072 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))));
invariant b0073 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))));
invariant b0074 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))));
invariant b0075 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0076 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0077 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0078 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0079 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0080 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0081 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0082 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0083 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0084 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0085 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0086 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0087 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0088 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0089 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0090 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0091 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0092 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0093 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0094 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0095 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0096 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0097 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0098 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0099 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0100 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#a,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0101 ==> ((F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0102 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#b,^s_node)),F#sll_keys($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0103 ==> ((F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0104 ==> ((F#sll_keys($s,$phys_ptr_cast(P#a,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(L#curr,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0105 ==> ((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0106 ==> ((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0107 ==> ((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0108 ==> ((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0109 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0110 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0111 ==> ((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0112 ==> ((($non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0113 ==> ((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0114 ==> ((($non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0115 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0116 ==> ((($non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0117 ==> (((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0118 ==> (((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0119 ==> (((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0120 ==> (((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0121 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0122 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_max_key($s,$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0123 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0124 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0125 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0126 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0127 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0128 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0129 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0130 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0131 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0132 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0133 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)))));
invariant b0134 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> (F#sll_lseg_max_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)))));
invariant b0135 ==> (((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0136 ==> (((F#srtl($s,$phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#a,^s_node)))));
invariant b0137 ==> (((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0138 ==> (((F#srtl($s,$phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(P#b,^s_node)))));
invariant b0139 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0140 ==> (((F#srtl($s,$phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_min_key($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant b0141 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))));
invariant b0142 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0143 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))));
invariant b0144 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0145 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))));
invariant b0146 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))));
invariant b0147 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))));
invariant b0148 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#a,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0149 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(L#curr,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(L#curr,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))));
invariant b0150 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)) && ($phys_ptr_cast(P#b,^s_node) != $phys_ptr_cast(L#curr,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant b0151 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#a,^s_node)) && $non_null($phys_ptr_cast(P#b,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#b,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))));
invariant b0152 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)) && ($phys_ptr_cast(L#curr,^s_node) != $phys_ptr_cast(P#b,^s_node)) && $non_null($phys_ptr_cast(P#a,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#a,^s_node)) <= F#sll_lseg_min_key($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))));
