...
p0027 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node))));
p0028 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0029 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node))));
p0030 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node))));
p0031 := ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node))));
p0032 := ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node))));
p0033 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node))));
p0034 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node))));
p0035 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node))));
p0036 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node))));
p0037 := ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node))));
p0038 := ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node))));
...
invariant (p0027 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant (p0028 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0029 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant (p0030 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0031 == ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#a,^s_node)))));
invariant (p0032 == ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#b,^s_node)))));
invariant (p0033 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0034 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#a,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#b,^s_node)))));
invariant (p0035 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(L#curr,^s_node)))));
invariant (p0036 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#b,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#curr,^s_node),$phys_ptr_cast(P#a,^s_node)))));
invariant (p0037 == ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#a,^s_node),$phys_ptr_cast(P#b,^s_node)))));
invariant (p0038 == ($oset_disjoint($oset_singleton($phys_ptr_cast(L#curr,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#b,^s_node),$phys_ptr_cast(P#a,^s_node)))));
