...
invariant b0064 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#tmp,^s_node)))));
invariant b0065 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#prev,^s_node)))));
...
invariant b0067 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0068 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#prev,^s_node)))));
invariant b0069 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0070 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0071 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#tmp,^s_node)))));
invariant b0072 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))));
...
invariant b0074 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#tmp,^s_node)))));
invariant b0075 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#prev,^s_node)))));
invariant b0076 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#tmp,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
invariant b0077 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#tmp,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant b0078 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#tmp,^s_node)))));
invariant b0079 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant b0080 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#tmp,^s_node)))));
invariant b0081 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
invariant b0082 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
invariant b0083 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant b0084 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant b0085 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant b0086 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant b0087 ==> (($non_null($phys_ptr_cast(L#tmp,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#tmp,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
invariant b0088 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#tmp,^s_node)))));
invariant b0089 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant b0090 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#tmp,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant b0091 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#tmp,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant b0092 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant b0093 ==> (($non_null($phys_ptr_cast(L#prev,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#prev,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(L#tmp,^s_node)))));
invariant b0094 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#tmp,^s_node)))));
invariant b0095 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
invariant b0096 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#tmp,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant b0097 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#tmp,^s_node),$phys_ptr_cast(L#prev,^s_node)))));
invariant b0098 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant b0099 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#prev,^s_node),$phys_ptr_cast(L#tmp,^s_node)))));
