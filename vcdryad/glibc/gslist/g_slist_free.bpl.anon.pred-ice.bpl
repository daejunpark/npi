...
p0008 := (($non_null($phys_ptr_cast(P#l,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#x,^s_node)))));
p0009 := (($non_null($phys_ptr_cast(L#x,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#x,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#l,^s_node)))));
...
invariant (p0008 == (($non_null($phys_ptr_cast(P#l,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#x,^s_node))))));
invariant (p0009 == (($non_null($phys_ptr_cast(L#x,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#x,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#l,^s_node))))));
