...
invariant b0022 ==> ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant b0023 ==> ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant b0024 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))))));
invariant b0025 ==> ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))))));
invariant b0026 ==> ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0027 ==> ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0028 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0029 ==> ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
...
invariant b0042 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < P#data)));
invariant b0043 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < P#data)));
