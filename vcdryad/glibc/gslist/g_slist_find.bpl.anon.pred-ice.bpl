...
p0022 := ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
p0023 := ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
p0024 := ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))))));
p0025 := ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))))));
p0026 := ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
p0027 := ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
p0028 := ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
p0029 := ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
...
p0036 := ((P#data < 2147483647));
p0037 := ((P#data < 2147483647));
p0038 := ((P#data < 4294967295));
p0039 := ((P#data < 4294967295));
p0040 := ((P#data >= 0));
p0041 := ((P#data >= 0));
p0042 := (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < P#data)));
p0043 := (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < P#data)));
...
invariant (p0022 == ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))))));
invariant (p0023 == ((!($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))))));
invariant (p0024 == ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))))));
invariant (p0025 == ((!($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))))));
invariant (p0026 == ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant (p0027 == ($intset_in(P#data,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant (p0028 == ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant (p0029 == ($intset_in(P#data,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))));
...
invariant (p0036 == ((P#data < 2147483647)));
invariant (p0037 == ((P#data < 2147483647)));
invariant (p0038 == ((P#data < 4294967295)));
invariant (p0039 == ((P#data < 4294967295)));
invariant (p0040 == ((P#data >= 0)));
invariant (p0041 == ((P#data >= 0)));
invariant (p0042 == (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < P#data))));
invariant (p0043 == (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < P#data))));
...
const unique #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cgslist?5Cg_slist_find.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cgslist?5Cg_slist_find.c);
