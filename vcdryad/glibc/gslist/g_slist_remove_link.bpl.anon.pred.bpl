...
invariant b0265 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0266 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0267 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0268 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0269 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0270 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0271 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0272 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0273 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0274 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0275 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0276 ==> (($is_null($phys_ptr_cast(P#list,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0277 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0278 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0279 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0280 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0281 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0282 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0283 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0284 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0285 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0286 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0287 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0288 ==> (($is_null($phys_ptr_cast(P#link,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0289 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0290 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0291 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0292 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0293 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0294 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0295 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0296 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0297 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0298 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0299 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0300 ==> (($is_null($phys_ptr_cast(L#tmp,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0301 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0302 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0303 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0304 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0305 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0306 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0307 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0308 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0309 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(local.list,^s_node))));
invariant b0310 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0311 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0312 ==> (($is_null($phys_ptr_cast(L#prev,^s_node)) ==> ($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0313 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0314 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0315 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0316 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0317 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
invariant b0318 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0319 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0320 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0321 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#tmp,^s_node) == $phys_ptr_cast(L#prev,^s_node))));
invariant b0322 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0323 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0324 ==> (($is_null($phys_ptr_cast(local.list,^s_node)) ==> ($phys_ptr_cast(L#prev,^s_node) == $phys_ptr_cast(L#tmp,^s_node))));
