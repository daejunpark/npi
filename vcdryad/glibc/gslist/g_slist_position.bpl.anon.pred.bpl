...
invariant b0027 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0028 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0029 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0030 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0031 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0032 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0033 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0034 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0035 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0036 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0037 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0038 ==> ($oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))));
