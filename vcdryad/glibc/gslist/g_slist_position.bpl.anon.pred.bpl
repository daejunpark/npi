...
invariant b0003 ==> (F#sll_lseg($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)));
invariant b0004 ==> (F#sll_lseg($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)));
invariant b0005 ==> (F#sll_lseg($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)));
invariant b0006 ==> (F#sll_lseg($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)));
invariant b0007 ==> (F#sll_lseg($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)));
invariant b0008 ==> (F#sll_lseg($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)));
invariant b0009 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0010 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0011 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0012 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0013 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0014 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0015 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node))));
...
invariant b0017 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0018 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node))));
...
invariant b0020 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0021 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0022 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0023 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0024 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0025 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0026 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0027 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))));
...
invariant b0029 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0030 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_reach($s,$phys_ptr_cast(local.list,^s_node)))));
...
invariant b0032 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0033 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant b0034 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)))));
invariant b0035 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)))));
invariant b0036 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant b0037 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)))));
invariant b0038 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)))));
invariant b0039 ==> ($non_null($phys_ptr_cast(P#list,^s_node)));
invariant b0040 ==> ($non_null($phys_ptr_cast(P#link,^s_node)));
invariant b0041 ==> ($non_null($phys_ptr_cast(local.list,^s_node)));
invariant b0042 ==> ($is_null($phys_ptr_cast(P#list,^s_node)));
invariant b0043 ==> ($is_null($phys_ptr_cast(P#link,^s_node)));
invariant b0044 ==> ($is_null($phys_ptr_cast(local.list,^s_node)));
invariant b0045 ==> (($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(P#link,^s_node)));
invariant b0046 ==> (($phys_ptr_cast(P#list,^s_node) == $phys_ptr_cast(local.list,^s_node)));
invariant b0047 ==> (($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(P#list,^s_node)));
invariant b0048 ==> (($phys_ptr_cast(P#link,^s_node) == $phys_ptr_cast(local.list,^s_node)));
invariant b0049 ==> (($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#list,^s_node)));
invariant b0050 ==> (($phys_ptr_cast(local.list,^s_node) == $phys_ptr_cast(P#link,^s_node)));
...
invariant b0052 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#link,^s_node),^s_node))));
...
invariant b0055 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#link,^s_node),^s_node))));
...
invariant b0057 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#list,^s_node),^s_node) == $phys_ptr_cast(P#link,^s_node))));
...
invariant b0059 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#link,^s_node),^s_node) == $phys_ptr_cast(P#list,^s_node))));
invariant b0060 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#link,^s_node),^s_node) == $phys_ptr_cast(local.list,^s_node))));
...
invariant b0062 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(local.list,^s_node),^s_node) == $phys_ptr_cast(P#link,^s_node))));
invariant b0063 ==> ((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))))));
invariant b0064 ==> ((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))))));
invariant b0065 ==> ((!($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))))));
invariant b0066 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))))));
invariant b0067 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))))));
invariant b0068 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))))));
invariant b0069 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))))));
invariant b0070 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))))));
invariant b0071 ==> ((!($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))))));
invariant b0072 ==> ($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0073 ==> ($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0074 ==> ($intset_in(L#i,F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0075 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0076 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0077 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0078 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0079 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0080 ==> ($intset_in(L#i,F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0081 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0082 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0083 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0084 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_keys($s,$phys_ptr_cast(local.list,^s_node))));
invariant b0085 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#list,^s_node))));
invariant b0086 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#link,^s_node))));
invariant b0087 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0088 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0089 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node))));
invariant b0090 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0091 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node))));
invariant b0092 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == F#sll_lseg_keys($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node))));
invariant b0093 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0094 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0095 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0096 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0097 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0098 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0099 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0100 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0101 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0102 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0103 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0104 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0105 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0106 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0107 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0108 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0109 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0110 ==> ((F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0111 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0112 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0113 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0114 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0115 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0116 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0117 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
invariant b0118 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#list,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0119 ==> ((F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0120 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(P#link,^s_node)),F#sll_keys($s,$phys_ptr_cast(local.list,^s_node)))));
invariant b0121 ==> ((F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)))));
invariant b0122 ==> ((F#sll_keys($s,$phys_ptr_cast(P#list,^s_node)) == $intset_union(F#sll_keys(loopState#0,$phys_ptr_cast(local.list,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#link,^s_node)))));
...
invariant b0132 ==> (($non_null($phys_ptr_cast(P#list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) < L#i)));
invariant b0133 ==> (($non_null($phys_ptr_cast(P#link,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) < L#i)));
invariant b0134 ==> (($non_null($phys_ptr_cast(local.list,^s_node)) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) < L#i)));
invariant b0135 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)))));
invariant b0136 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0137 ==> ((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0138 ==> ((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0139 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0140 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)))));
invariant b0141 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)))));
invariant b0142 ==> ((($non_null($phys_ptr_cast(P#list,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0143 ==> ((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0144 ==> ((($non_null($phys_ptr_cast(P#link,^s_node)) && $non_null($phys_ptr_cast(local.list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)))));
invariant b0145 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#list,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#list,^s_node)))));
invariant b0146 ==> ((($non_null($phys_ptr_cast(local.list,^s_node)) && $non_null($phys_ptr_cast(P#link,^s_node))) ==> ($rd_inv($s,s_node.key,$phys_ptr_cast(local.list,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#link,^s_node)))));
invariant b0147 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) == L#i));
invariant b0148 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) == L#i));
invariant b0149 ==> ((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) == L#i));
invariant b0150 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(P#link,^s_node)) == L#i));
invariant b0151 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#list,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#i));
invariant b0152 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#i));
invariant b0153 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#link,^s_node),$phys_ptr_cast(local.list,^s_node)) == L#i));
invariant b0154 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#list,^s_node)) == L#i));
invariant b0155 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(local.list,^s_node),$phys_ptr_cast(P#link,^s_node)) == L#i));
invariant b0156 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node))) == L#i));
invariant b0157 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#i));
invariant b0158 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#i));
invariant b0159 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node))) == L#i));
invariant b0160 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#list,^s_node))) == L#i));
invariant b0161 ==> (((F#sll_list_len_next($s,$phys_ptr_cast(local.list,^s_node)) - F#sll_list_len_next($s,$phys_ptr_cast(P#link,^s_node))) == L#i));
