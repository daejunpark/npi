...
implementation g_slist_free(P#l: $ptr) returns (OP#ALL_REACH: $oset)
{
  ...
  anon4:
    ...
    assume true;
    while (true)
      invariant F#sll($s, $phys_ptr_cast(L#x, ^s_node));
...
const unique #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Cglibc?5Cgslist?5Cg_slist_free.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Cglibc?5Cgslist?5Cg_slist_free.c);
