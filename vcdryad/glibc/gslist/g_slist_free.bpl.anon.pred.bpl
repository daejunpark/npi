...
// INV:LOOPHEAD
    while (true)
invariant b0000 ==> (F#sll($s,$phys_ptr_cast(P#l,^s_node)));
invariant b0001 ==> (F#sll($s,$phys_ptr_cast(L#x,^s_node)));
invariant b0002 ==> (F#sll_lseg($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#x,^s_node)));
invariant b0003 ==> (F#sll_lseg($s,$phys_ptr_cast(L#x,^s_node),$phys_ptr_cast(P#l,^s_node)));
invariant b0004 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#l,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#x,^s_node))));
invariant b0005 ==> ($oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#x,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#l,^s_node))));
invariant b0006 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#l,^s_node),$phys_ptr_cast(L#x,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#x,^s_node))));
invariant b0007 ==> ($oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#x,^s_node),$phys_ptr_cast(P#l,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#l,^s_node))));
invariant b0008 ==> (($non_null($phys_ptr_cast(P#l,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#l,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#x,^s_node)))));
invariant b0009 ==> (($non_null($phys_ptr_cast(L#x,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#x,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#l,^s_node)))));
invariant b0010 ==> ($non_null($phys_ptr_cast(P#l,^s_node)));
invariant b0011 ==> ($non_null($phys_ptr_cast(L#x,^s_node)));
invariant b0012 ==> ($is_null($phys_ptr_cast(P#l,^s_node)));
invariant b0013 ==> ($is_null($phys_ptr_cast(L#x,^s_node)));
invariant b0014 ==> (($phys_ptr_cast(P#l,^s_node) == $phys_ptr_cast(L#x,^s_node)));
invariant b0015 ==> (($phys_ptr_cast(L#x,^s_node) == $phys_ptr_cast(P#l,^s_node)));
invariant b0016 ==> (($non_null($phys_ptr_cast(P#l,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node))));
invariant b0017 ==> (($non_null($phys_ptr_cast(L#x,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#x,^s_node),^s_node))));
invariant b0018 ==> (($non_null($phys_ptr_cast(P#l,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node))));
invariant b0019 ==> (($non_null($phys_ptr_cast(L#x,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#x,^s_node),^s_node))));
invariant b0020 ==> (($non_null($phys_ptr_cast(P#l,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#l,^s_node),^s_node) == $phys_ptr_cast(L#x,^s_node))));
invariant b0021 ==> (($non_null($phys_ptr_cast(L#x,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#x,^s_node),^s_node) == $phys_ptr_cast(P#l,^s_node))));
