...
p0008 := ($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#x,^d_node))));
p0009 := ($oset_disjoint($oset_singleton($phys_ptr_cast(L#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node))));
...
invariant (p0008 == ($oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#x,^d_node)))));
invariant (p0009 == ($oset_disjoint($oset_singleton($phys_ptr_cast(L#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)))));
