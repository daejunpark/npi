...
invariant b0008 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0009 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)))));
...
invariant b0022 ==> ((!($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant b0023 ==> ((!($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant b0024 ==> ((!($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant b0025 ==> ((!($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant b0026 ==> ((!($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))))));
invariant b0027 ==> ((!($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))))));
invariant b0028 ==> ((!($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0029 ==> ((!($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0030 ==> ($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0031 ==> ($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0032 ==> ($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0033 ==> ($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0034 ==> ($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))));
invariant b0035 ==> ($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))));
invariant b0036 ==> ($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0037 ==> ($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))));
...
invariant b0040 ==> ((F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0041 ==> ((F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0042 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0043 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
...
invariant b0056 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#n)));
invariant b0057 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < local.n)));
invariant b0058 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#n)));
invariant b0059 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < local.n)));
...
invariant b0064 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#n));
invariant b0065 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == local.n));
invariant b0066 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#n));
invariant b0067 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == local.n));
invariant b0068 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#n));
invariant b0069 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == local.n));
invariant b0070 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#n));
invariant b0071 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == local.n));
invariant b0072 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n)));
invariant b0073 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n)));
invariant b0074 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n)));
invariant b0075 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n)));
invariant b0076 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n)));
invariant b0077 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n)));
invariant b0078 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n)));
invariant b0079 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n)));
invariant b0080 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#n));
invariant b0081 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == local.n));
invariant b0082 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#n));
invariant b0083 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == local.n));
invariant b0084 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#n - local.n)));
invariant b0085 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (local.n - P#n)));
invariant b0086 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#n - local.n)));
invariant b0087 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (local.n - P#n)));
