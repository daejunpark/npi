...
invariant b0008 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(L#x,^d_node)))));
invariant b0009 ==> (($non_null($phys_ptr_cast(L#x,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#x,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)))));
