...
const unique ^$#g_list_find.c..36263#3: $ctype;

axiom $def_fnptr_type(^$#g_list_find.c..36263#3);

type $#g_list_find.c..36263#3;
...
const unique #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Cglibc?5Cglist?5Cg_list_find.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5Csubmit?5Cglibc?5Cglist?5Cg_list_find.c);
