...
invariant b0001 ==> (F#dll($s,$phys_ptr_cast(P#link,^d_node)));
invariant b0002 ==> (F#dll($s,$phys_ptr_cast(local.list,^d_node)));
invariant b0003 ==> (F#dll_lseg($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(P#link,^d_node)));
invariant b0004 ==> (F#dll_lseg($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)));
invariant b0005 ==> (F#dll_lseg($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(P#list,^d_node)));
invariant b0006 ==> (F#dll_lseg($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(local.list,^d_node)));
invariant b0007 ==> (F#dll_lseg($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)));
invariant b0008 ==> (F#dll_lseg($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#link,^d_node)));
invariant b0009 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#link,^d_node))));
invariant b0010 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0011 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#link,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0012 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(P#link,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0013 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(local.list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0014 ==> ($oset_disjoint(F#dll_reach($s,$phys_ptr_cast(local.list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#link,^d_node))));
invariant b0015 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(P#link,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#link,^d_node))));
...
invariant b0017 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0018 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(local.list,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.list,^d_node))));
...
invariant b0020 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#link,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#link,^d_node))));
invariant b0021 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(P#link,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0022 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#link,^d_node))));
invariant b0023 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0024 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(local.list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0025 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#link,^d_node))));
invariant b0026 ==> ($oset_disjoint(F#dll_lseg_reach($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#link,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0027 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#link,^d_node)))));
...
invariant b0029 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0030 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^d_node)),F#dll_reach($s,$phys_ptr_cast(local.list,^d_node)))));
...
invariant b0032 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^d_node)),F#dll_reach($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0033 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(local.list,^d_node)))));
invariant b0034 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#list,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#link,^d_node)))));
invariant b0035 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)))));
invariant b0036 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#link,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))));
invariant b0037 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(P#link,^d_node)))));
invariant b0038 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(local.list,^d_node)),F#dll_lseg_reach($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(P#list,^d_node)))));
invariant b0039 ==> ($non_null($phys_ptr_cast(P#list,^d_node)));
invariant b0040 ==> ($non_null($phys_ptr_cast(P#link,^d_node)));
invariant b0041 ==> ($non_null($phys_ptr_cast(local.list,^d_node)));
invariant b0042 ==> ($is_null($phys_ptr_cast(P#list,^d_node)));
invariant b0043 ==> ($is_null($phys_ptr_cast(P#link,^d_node)));
invariant b0044 ==> ($is_null($phys_ptr_cast(local.list,^d_node)));
invariant b0045 ==> (($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(P#link,^d_node)));
invariant b0046 ==> (($phys_ptr_cast(P#list,^d_node) == $phys_ptr_cast(local.list,^d_node)));
invariant b0047 ==> (($phys_ptr_cast(P#link,^d_node) == $phys_ptr_cast(P#list,^d_node)));
invariant b0048 ==> (($phys_ptr_cast(P#link,^d_node) == $phys_ptr_cast(local.list,^d_node)));
invariant b0049 ==> (($phys_ptr_cast(local.list,^d_node) == $phys_ptr_cast(P#list,^d_node)));
invariant b0050 ==> (($phys_ptr_cast(local.list,^d_node) == $phys_ptr_cast(P#link,^d_node)));
...
invariant b0052 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> $non_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#link,^d_node),^d_node))));
...
invariant b0055 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> $is_null($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#link,^d_node),^d_node))));
...
invariant b0057 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#list,^d_node),^d_node) == $phys_ptr_cast(P#link,^d_node))));
...
invariant b0059 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#link,^d_node),^d_node) == $phys_ptr_cast(P#list,^d_node))));
invariant b0060 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(P#link,^d_node),^d_node) == $phys_ptr_cast(local.list,^d_node))));
...
invariant b0062 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_phys_ptr($s,d_node.next,$phys_ptr_cast(local.list,^d_node),^d_node) == $phys_ptr_cast(P#link,^d_node))));
invariant b0063 ==> ((!($intset_in(L#i,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant b0064 ==> ((!($intset_in(L#i,F#dll_keys($s,$phys_ptr_cast(P#link,^d_node))))));
invariant b0065 ==> ((!($intset_in(L#i,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant b0066 ==> ((!($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(P#link,^d_node))))));
invariant b0067 ==> ((!($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))))));
invariant b0068 ==> ((!($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0069 ==> ((!($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(local.list,^d_node))))));
invariant b0070 ==> ((!($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))))));
invariant b0071 ==> ((!($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#link,^d_node))))));
invariant b0072 ==> ($intset_in(L#i,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0073 ==> ($intset_in(L#i,F#dll_keys($s,$phys_ptr_cast(P#link,^d_node))));
invariant b0074 ==> ($intset_in(L#i,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0075 ==> ($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(P#link,^d_node))));
invariant b0076 ==> ($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))));
invariant b0077 ==> ($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0078 ==> ($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(local.list,^d_node))));
invariant b0079 ==> ($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0080 ==> ($intset_in(L#i,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#link,^d_node))));
invariant b0081 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#link,^d_node))));
invariant b0082 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0083 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0084 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
invariant b0085 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
invariant b0086 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_keys($s,$phys_ptr_cast(P#link,^d_node))));
invariant b0087 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(local.list,^d_node))));
invariant b0088 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#link,^d_node))));
invariant b0089 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))));
invariant b0090 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0091 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(P#link,^d_node))));
invariant b0092 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == F#dll_lseg_keys($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(P#list,^d_node))));
invariant b0093 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0094 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0095 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0096 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0097 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0098 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0099 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0100 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0101 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0102 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0103 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0104 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0105 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0106 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0107 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0108 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0109 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0110 ==> ((F#dll_keys(loopState#21,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0111 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0112 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0113 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0114 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0115 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0116 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0117 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0118 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0119 ==> ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0120 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(P#link,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant b0121 ==> ((F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant b0122 ==> ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#21,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#link,^d_node)))));
invariant b0123 ==> ((L#i < 2147483647));
invariant b0124 ==> ((L#i < 2147483647));
invariant b0125 ==> ((L#i < 2147483647));
invariant b0126 ==> ((L#i < 4294967295));
invariant b0127 ==> ((L#i < 4294967295));
invariant b0128 ==> ((L#i < 4294967295));
invariant b0129 ==> ((L#i >= 0));
invariant b0130 ==> ((L#i >= 0));
invariant b0131 ==> ((L#i >= 0));
invariant b0132 ==> (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < L#i)));
invariant b0133 ==> (($non_null($phys_ptr_cast(P#link,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)) < L#i)));
invariant b0134 ==> (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < L#i)));
invariant b0135 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(P#link,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)))));
invariant b0136 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)))));
invariant b0137 ==> ((($non_null($phys_ptr_cast(P#link,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0138 ==> ((($non_null($phys_ptr_cast(P#link,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)))));
invariant b0139 ==> ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0140 ==> ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#link,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) <= $rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)))));
invariant b0141 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(P#link,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)))));
invariant b0142 ==> ((($non_null($phys_ptr_cast(P#list,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)))));
invariant b0143 ==> ((($non_null($phys_ptr_cast(P#link,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0144 ==> ((($non_null($phys_ptr_cast(P#link,^d_node)) && $non_null($phys_ptr_cast(local.list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)))));
invariant b0145 ==> ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#list,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)))));
invariant b0146 ==> ((($non_null($phys_ptr_cast(local.list,^d_node)) && $non_null($phys_ptr_cast(P#link,^d_node))) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) == $rd_inv($s,d_node.key,$phys_ptr_cast(P#link,^d_node)))));
invariant b0147 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == L#i));
invariant b0148 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(P#link,^d_node)) == L#i));
invariant b0149 ==> ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == L#i));
invariant b0150 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(P#link,^d_node)) == L#i));
invariant b0151 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == L#i));
invariant b0152 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(P#list,^d_node)) == L#i));
invariant b0153 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#link,^d_node),$phys_ptr_cast(local.list,^d_node)) == L#i));
invariant b0154 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == L#i));
invariant b0155 ==> ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#link,^d_node)) == L#i));
invariant b0156 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#link,^d_node))) == L#i));
invariant b0157 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == L#i));
invariant b0158 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#link,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == L#i));
invariant b0159 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(P#link,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == L#i));
invariant b0160 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == L#i));
invariant b0161 ==> (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#link,^d_node))) == L#i));
