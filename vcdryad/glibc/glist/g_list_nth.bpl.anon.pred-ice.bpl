...
const unique ^$#g_list_nth.c..36776#3: $ctype;

axiom $def_fnptr_type(^$#g_list_nth.c..36776#3);

type $#g_list_nth.c..36776#3;
...
p0022 := ((!($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
p0023 := ((!($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
p0024 := ((!($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
p0025 := ((!($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
p0026 := ((!($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))))));
p0027 := ((!($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))))));
p0028 := ((!($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))))));
p0029 := ((!($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))))));
p0030 := ($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
p0031 := ($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))));
p0032 := ($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
p0033 := ($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))));
p0034 := ($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))));
p0035 := ($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node))));
p0036 := ($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))));
p0037 := ($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node))));
...
p0040 := ((F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
p0041 := ((F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
p0042 := ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
p0043 := ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
...
p0054 := ((P#n >= 0));
p0055 := ((local.n >= 0));
p0056 := (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#n)));
p0057 := (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < local.n)));
p0058 := (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#n)));
p0059 := (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < local.n)));
...
p0064 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#n));
p0065 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == local.n));
p0066 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#n));
p0067 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == local.n));
p0068 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#n));
p0069 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == local.n));
p0070 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#n));
p0071 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == local.n));
p0072 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n)));
p0073 := ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n)));
p0074 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n)));
p0075 := ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n)));
p0076 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n)));
p0077 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n)));
p0078 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n)));
p0079 := ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n)));
p0080 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#n));
p0081 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == local.n));
p0082 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#n));
p0083 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == local.n));
p0084 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#n - local.n)));
p0085 := (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (local.n - P#n)));
p0086 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#n - local.n)));
p0087 := (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (local.n - P#n)));
...
invariant (p0022 == ((!($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))))));
invariant (p0023 == ((!($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))))));
invariant (p0024 == ((!($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))))));
invariant (p0025 == ((!($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))))));
invariant (p0026 == ((!($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)))))));
invariant (p0027 == ((!($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)))))));
invariant (p0028 == ((!($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))))));
invariant (p0029 == ((!($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))))));
invariant (p0030 == ($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant (p0031 == ($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)))));
invariant (p0032 == ($intset_in(P#n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant (p0033 == ($intset_in(local.n,F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)))));
invariant (p0034 == ($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)))));
invariant (p0035 == ($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)))));
invariant (p0036 == ($intset_in(P#n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))));
invariant (p0037 == ($intset_in(local.n,F#dll_lseg_keys($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)))));
...
invariant (p0040 == ((F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0041 == ((F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
invariant (p0042 == ((F#dll_keys($s,$phys_ptr_cast(P#list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(P#list,^d_node)),F#dll_keys($s,$phys_ptr_cast(local.list,^d_node))))));
invariant (p0043 == ((F#dll_keys($s,$phys_ptr_cast(local.list,^d_node)) == $intset_union(F#dll_keys(loopState#19,$phys_ptr_cast(local.list,^d_node)),F#dll_keys($s,$phys_ptr_cast(P#list,^d_node))))));
...
invariant (p0056 == (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < P#n))));
invariant (p0057 == (($non_null($phys_ptr_cast(P#list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(P#list,^d_node)) < local.n))));
invariant (p0058 == (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < P#n))));
invariant (p0059 == (($non_null($phys_ptr_cast(local.list,^d_node)) ==> ($rd_inv($s,d_node.key,$phys_ptr_cast(local.list,^d_node)) < local.n))));
...
invariant (p0064 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == P#n)));
invariant (p0065 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == local.n)));
invariant (p0066 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == P#n)));
invariant (p0067 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == local.n)));
invariant (p0068 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == P#n)));
invariant (p0069 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == local.n)));
invariant (p0070 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == P#n)));
invariant (p0071 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == local.n)));
invariant (p0072 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n))));
invariant (p0073 == ((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n))));
invariant (p0074 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n))));
invariant (p0075 == ((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n))));
invariant (p0076 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (P#n - local.n))));
invariant (p0077 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(P#list,^d_node),$phys_ptr_cast(local.list,^d_node)) == (local.n - P#n))));
invariant (p0078 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (P#n - local.n))));
invariant (p0079 == ((F#dll_lseg_len_next($s,$phys_ptr_cast(local.list,^d_node),$phys_ptr_cast(P#list,^d_node)) == (local.n - P#n))));
invariant (p0080 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == P#n)));
invariant (p0081 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == local.n)));
invariant (p0082 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == P#n)));
invariant (p0083 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == local.n)));
invariant (p0084 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (P#n - local.n))));
invariant (p0085 == (((F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node))) == (local.n - P#n))));
invariant (p0086 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (P#n - local.n))));
invariant (p0087 == (((F#dll_list_len_next($s,$phys_ptr_cast(local.list,^d_node)) - F#dll_list_len_next($s,$phys_ptr_cast(P#list,^d_node))) == (local.n - P#n))));
...
true
      ...
      invariant $non_null($phys_ptr_cast(local.list, ^d_node)) ==> $top_writable($s, #wrTime$3^4.3, $phys_ptr_cast(local.list, ^d_node));
    {
      anon160:
        ...
        assume $timestamp_post(loopState#19, $s);
        assume $full_stop_ext(#tok$3^17.3, $s);
        // assume @_vcc_meta_eq(old(@prestate, @state), @state); 
        assume $meta_eq(loopState#19, $s);
        // _Bool ite#1; 
...
const unique #file^c?3A?5CUsers?5CDaniel?5CWorkspace?5CVCDryad_Bin?5CTests?5Cglist?5Cg_list_nth.c: $token;

axiom $file_name_is(3, #file^c?3A?5CUsers?5CDaniel?5CWorkspace?5CVCDryad_Bin?5CTests?5Cglist?5Cg_list_nth.c);
